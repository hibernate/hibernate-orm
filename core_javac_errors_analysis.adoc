...
### PersistentCollection metadata (17)
...
### Yet-uncategorized Type methods/usages (5)
...
### Access to Navigable value from an instance of its container (2)
