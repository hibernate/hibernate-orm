...
/home/sebersole/projects/hibernate/hibernate-orm/master/hibernate-orm/hibernate-core/src/main/java/org/hibernate/sql/results/internal/RowReaderStandardImpl.java:97: error: cannot find symbol
				( (EntityInitializer) initializer ).resolveEntityState( rowProcessingState );
				                                   ^
  symbol:   method resolveEntityState(RowProcessingState)
  location: interface EntityInitializer
