...
If the natural id is a composite key spanning multiple attributes, the link:{doc-javadoc-url}org/hibernate/annotations/NaturalIdClass.html[`@NaturalIdClass`] may be used.
