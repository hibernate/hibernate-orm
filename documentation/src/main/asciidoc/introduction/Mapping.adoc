...
- set the configuration property `hibernate.default_schema` (or `hibernate.default_catalog`),
- use `@DefaultSchema(schema="...")` on a class, `package-info.java`, or `module-info.java` to scope the default schema to specific entities, or
