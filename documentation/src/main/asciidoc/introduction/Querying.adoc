...
| Selection | `createNamedQuery(TypedQueryReference)`, `createNamedQuery(String,Class)` | `TypedQuery` | `getResultList()`, `getSingleResult()`, `getSingleResultOrNull()`
| Mutation | `createNamedQuery(TypedQueryReference)`, `createNamedQuery(String)` | `Statement` | `execute()`
|===
