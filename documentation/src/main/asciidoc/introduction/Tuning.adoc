...
[TIP]
====
We may request subselect fetching more selectively by annotating a collection or association with the link:{doc-javadoc-url}/org/hibernate/annotations/Fetch.html[`@Fetch`] annotation.
[source,java]
----
