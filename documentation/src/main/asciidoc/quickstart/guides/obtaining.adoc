...
hibernate-orm-spatial:: Hibernate's Spatial/GIS data-type support
...
* The `lib/spatial/` directory contains the `hibernate-orm-spatial` jar and all of its dependencies (beyond those in `lib/required/`)
