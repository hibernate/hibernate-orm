...
| `jakarta.data:jakarta.data.stateful-api` | Jakarta Data Stateful Repositories API
...
Methods of a repository interface may be annotated with:

- Jakarta Bean Validation constraint annotations (per Jakarta Data specification),
