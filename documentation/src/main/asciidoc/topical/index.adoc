...
* The link:{doc-spi-url}[Hibernate ORM SPI and Service Provider Guide] explains provider roles, lifecycle, packaging, and compatibility.
* The link:{doc-dialect-provider-url}[Dialect Provider Guide] is the end-to-end guide for maintaining an external SQL Dialect.
