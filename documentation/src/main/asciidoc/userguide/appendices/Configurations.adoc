...
`hibernate.cache.check_second_level_cache_polymorphic_proxies` (e.g. `true` (default value) of `false`)::
Forces Hibernate to check the second-level cache for polymorphic entities prior to creating a proxy.
