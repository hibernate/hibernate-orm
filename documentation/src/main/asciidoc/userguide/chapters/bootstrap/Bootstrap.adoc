...
{doc-version-base-url}/javadocs/org/hibernate/jpa/HibernatePersistenceProvider.html#createContainerEntityManagerFactory(jakarta.persistence.spi.PersistenceUnitInfo,java.util.Map)[`HibernatePersistenceProvider#createContainerEntityManagerFactory()`].
====
