...
[NOTE]
====
Not all databases support these nationalized types.  Attempting to use these nationalized
types on those databases will result in an exception
====
...
By default, Hibernate maps values of `Character` to the `CHAR` JDBC type.

[[basic-character-example-implicit]]
.Mapping Character
====
[source, JAVA, indent=0]
----
...
By default, Hibernate maps values of `String` to the `VARCHAR` JDBC type.
...
[source, JAVA, indent=0]
----
include::{sourcedir}/basic/StringMappingTests.java[tags=basic-string-example-implicit]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/basic/NationalizedStringMappingTests.java[tags=basic-nstring-example-implicit]
----
====
...
By default, Hibernate maps values of `Character[]` and `char[]` to the `VARCHAR` JDBC type.

[[basic-chararray-example]]
.Mapping character arrays
====
[source, JAVA, indent=0]
----
include::{sourcedir}/basic/CharacterArrayMappingTests.java[tags=basic-chararray-examples]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/basic/NationalizedCharacterArrayMappingTests.java[tags=basic-nchararray-example]
----
====
