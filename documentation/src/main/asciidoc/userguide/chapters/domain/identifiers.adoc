...
<<settings-hibernate.jpa.compliance.global_id_generators,`hibernate.jpa.compliance.global_id_generators`>>
...
Disabling global generator-name scoping is deprecated and will no longer be supported in Hibernate ORM 9.0.
