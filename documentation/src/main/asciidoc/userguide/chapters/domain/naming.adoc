...
The same setting may be applied through native bootstrap.  See
<<chapters/bootstrap/Bootstrap.adoc#bootstrap,Bootstrap>> for additional details.
...
The same setting may be applied through native bootstrap.
See <<chapters/bootstrap/Bootstrap.adoc#bootstrap,Bootstrap>> for additional details.
