...
|`org.hibernate.envers.audit_strategy_validity_legacy_revend_timestamp` |`true` |Should use legacy validity-based audit strategy's joined inheritance-based revision end timestamp behavior.


  When enabled, the revision end timestamp is only maintained in the root entity of the hierarchy.
  When disabled, the revision end timestamp will be maintained in all audit tables of the joined entity inheritance-strategy mapping.
|=======================================================================
