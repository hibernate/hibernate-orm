...
[IMPORTANT]
====
To use the c3p0 integration, the application must include the `hibernate-c3p0` module jar on the classpath,
as well as an appropriate version of `com.mchange:c3p0`.

This version of Hibernate ORM was tested with c3p0 {c3p0Version}.
====
...
[IMPORTANT]
====
To use the HikariCP integration, the application must include the `hibernate-hikaricp` module jar on the classpath,
as well as an appropriate version of `com.zaxxer:HikariCP`.

This version of Hibernate ORM was tested with HikariCP {hikaricpVersion}.
====
...
[IMPORTANT]
====
To use the Agroal integration, the application must include the `hibernate-agroal` module jar on the classpath,
as well as an appropriate version of `io.agroal:agroal-pool`.

This version of Hibernate ORM was tested with Agroal {agroalVersion}.
====
...
[IMPORTANT]
====
To use the Oracle Universal Connection Pool (aka UCP) integration, the application must include the `hibernate-ucp` module jar on the classpath,
as well as appropriate versions of `com.oracle.database.jdbc:ucp17` and `com.oracle.database.jdbc:ojdbc17`.

This version of Hibernate ORM was tested with Oracle JDBC {oracleVersion}.
====
