...
|Firebird |Support for the Firebird database, version 2.1 and earlier
|Firebird25 |Support for the Firebird database, version 2.5
|Firebird30 |Support for the Firebird database, version 3.0
