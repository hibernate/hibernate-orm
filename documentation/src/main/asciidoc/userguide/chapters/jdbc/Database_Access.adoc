...
[NOTE]
====
For JPA applications, note that `hibernate.connection.datasource` corresponds to either `jakarta.persistence.jtaDataSource` or `jakarta.persistence.nonJtaDataSource`.
====
