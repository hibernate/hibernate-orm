...
[IMPORTANT]
====
Just like with `ScrollableResults`, you should always close a Hibernate `Stream` either explicitly or using an https://docs.oracle.com/javase/tutorial/essential/exceptions/tryResourceClose.html[try-with-resources] block.
====
