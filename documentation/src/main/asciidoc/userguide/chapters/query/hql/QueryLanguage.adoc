...
| `sum(element x)`| &mdash; | Collections of basic type | The sum of the elements
| `avg(element x)`| &mdash; | Collections of basic type | The sum of the elements
...
| `sum(index x)`| &mdash; | Indexed collections (lists and maps) | The sum of the list indexes or map keys
| `avg(index x)`| &mdash; | Indexed collections (lists and maps) | The average of the list indexes or map keys
|===
