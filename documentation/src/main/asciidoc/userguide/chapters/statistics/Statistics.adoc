...
If the maximum number of queries has been reached, Hibernate uses an https://en.wikipedia.org/wiki/Cache_replacement_policies#Least_recently_used_(LRU)[Least recently used (LRU)] policy
