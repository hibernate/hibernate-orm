...
<<bootstrap/Bootstrap.adoc#bootstrap-jpa-compliant,JTA>>
...
TransactionManager, UserTransaction, etc. See <<jndi/JNDI.adoc#jndi,JNDI>> for
...
are shown in <<batch/Batching.adoc#batch,Batching>>. Keeping a Session open for the duration
