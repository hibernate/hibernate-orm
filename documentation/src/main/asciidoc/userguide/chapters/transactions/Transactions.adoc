...
`jta`:: Manages transactions via JTA. See <<chapters/bootstrap/Bootstrap.adoc#PersistenceUnitInfo,Java EE bootstrapping>>
...
https://docs.hibernate.org/orm/{majorMinorVersion}/integrationguide/html_single/[Integration Guide] .
====
