...
public abstract class AbstractMultiTenancyTest extends BaseUnitTestCase {
    ...
    protected SessionFactory sessionFactory(Map<String, Object> settings) {
        ...
        final TargetDatabaseImpl frontEndTarget = new TargetDatabaseImpl( new JdbcConnectionAccessImpl( connectionProviderMap.get( FRONT_END_TENANT ) ) );
        final TargetDatabaseImpl backEndTarget = new TargetDatabaseImpl( new JdbcConnectionAccessImpl( connectionProviderMap.get( BACK_END_TENANT ) ) );
