 ...
 * returning true, and without setting a configuration option explicitly for LOG_JDBC_WARNINGS.
 *
 * @author Sanne Grinovero
 */
@RequiresDialectFeature(DialectChecks.SupportsJdbcDriverProxying.class)
public class AgroalSkipClearWarningsByDefaultTest extends BaseCoreFunctionalTestCase {
