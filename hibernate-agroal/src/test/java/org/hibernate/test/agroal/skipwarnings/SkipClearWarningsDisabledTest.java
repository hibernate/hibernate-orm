...
public class SkipClearWarningsDisabledTest extends BaseCoreFunctionalTestCase {

	private PreparedStatementSpyConnectionProvider connectionProvider = new PreparedStatementSpyConnectionProvider( false );
	...
	public void test() {
		...
		assertEquals( 2, connectionProvider.getCountInvocationsToClearWarnings() );
	}
