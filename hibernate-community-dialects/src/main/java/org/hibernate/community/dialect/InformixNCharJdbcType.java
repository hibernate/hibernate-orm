 ...
 */
public class InformixNCharJdbcType extends InformixNVarcharJdbcType {
	public static final InformixNCharJdbcType INSTANCE = new InformixNCharJdbcType();

	public InformixNCharJdbcType() {
	}
