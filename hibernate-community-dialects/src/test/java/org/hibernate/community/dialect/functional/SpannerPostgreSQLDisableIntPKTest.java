...
public class SpannerPostgreSQLDisableIntPKTest {
	...
	@Test
	@FailureExpected(reason = "Spanner bit-reversed sequences return very large Long values. "
							+ "When these are cast to Integer values, the produced Integers are non-unique, "
							+ "causing a NonUniqueObjectException to be thrown.")
