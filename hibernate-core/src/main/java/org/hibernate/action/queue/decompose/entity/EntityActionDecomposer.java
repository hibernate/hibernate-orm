...
public interface EntityActionDecomposer<A extends Executable> {
	/// Decompose the [action][Executable] into its constituent [table operations][PlannedOperation].
	///
	...
	/// @param operationConsumer Consumer for any [table operations][PlannedOperation] produced
	void decompose(
			A action,
			int ordinalBase,
