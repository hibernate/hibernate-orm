...
/// [org.hibernate.action.queue.spi.bind.DelayedValueAccess].  This is handled in
/// [org.hibernate.action.queue.internal.cyclebreak.CycleBreakPatcher].
...
/// [org.hibernate.action.queue.internal.exec.FlushOperationExecutor#synthesizeFixupUpdateIfNeeded(FlushOperation, Object)] and
/// is added back to the [org.hibernate.action.queue.internal.plan.FlushPlan] as a follow-up step.  The update could be executed immediately,
