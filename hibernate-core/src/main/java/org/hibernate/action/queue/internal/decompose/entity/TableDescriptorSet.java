...
/// Represents a Set of TableDescriptor(s); table mappings are
...
/// which is typically more efficient than using a [java.util.Set].
/// These table ids come from [TableMapping#getRelativePosition].
/// N.B. Make sure to not store TableMappings from different
/// persisters, as their unique identifiers will overlap:
/// we'll only verify a mismatch if assertions are enabled.
