...
public class ColumnValueBindingBuilder {
	...
	public static ColumnValueBinding createValueBinding(
			@Nullable String writeValueExpression,
	...
	private static ColumnWriteFragment buildParameterizedWriteFragment(
			...
			ParameterUsage parameterUsage,
			Consumer<Object> parameterConsumer) {
		final JdbcType jdbcType = columnDescriptor.jdbcMapping().getJdbcType();
		final EmbeddableMappingType aggregateMappingType = jdbcType instanceof AggregateJdbcType aggregateJdbcType
