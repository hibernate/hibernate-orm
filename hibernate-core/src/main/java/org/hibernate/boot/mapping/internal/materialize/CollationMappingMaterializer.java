...
import org.hibernate.boot.mapping.internal.context.CollationPropertyHandoff;
...
public class CollationMappingMaterializer {
	public void materializeCollation(CollationContributionView contribution, Property property, BindingState state) {
		...
		if ( value instanceof OneToMany ) {
			...
			state.addCollationPropertyHandoff( new CollationPropertyHandoff( contribution, property ) );
		}
	}
}
