...
import static org.hibernate.boot.mapping.internal.xml.UserTypeCasesMapKey.MAP_KEY_USER_TYPE_CASES;
import static org.hibernate.boot.mapping.internal.xml.UserTypeCasesStandard.STANDARD_USER_TYPE_CASES;
...
public class XmlAnnotationHelper {
	...
	public static void applyUuidGenerator(
		...
		if ( !memberDetails.hasDirectAnnotationUsage( GeneratedValue.class ) ) {
