...
/**
 * SecondPass implementing delayed resolution of id-generators.
 *
 * @author Steve Ebersole
 */
public class BetterIdGeneratorResolverSecondPass implements IdGeneratorResolver {
	...
	public BetterIdGeneratorResolverSecondPass(
	...
	private void handleUnnamedSequenceGenerator() {
		// todo (7.0) : null or entityMapping.getJpaEntityName() for "name from generated-value"?
