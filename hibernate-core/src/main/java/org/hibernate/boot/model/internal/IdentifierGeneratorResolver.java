 ...
 *
 * @see StrictIdentifierGeneratorResolver
 *
 * @author Steve Ebersole
 */
public class IdentifierGeneratorResolver extends AbstractEntityIdGeneratorResolver {
	public IdentifierGeneratorResolver(
	...
	private boolean handleAsLocalAutoGenerator() {
		if ( "increment".equals( generatedValue.generator() ) ) {
			final var incrementGenerator =
					new GenericGeneratorAnnotation( buildingContext.getModelsContext() );
