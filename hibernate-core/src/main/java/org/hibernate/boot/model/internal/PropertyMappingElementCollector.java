...
public final class PropertyMappingElementCollector {
	...
	public void collectPersistentAttributesIfMatching(JaxbAttributesContainer container) {
		if ( container instanceof JaxbAttributesContainerImpl ) {
			final JaxbAttributesContainerImpl jaxbAttributes = (JaxbAttributesContainerImpl) container;
	...
	public void collectTenantIdIfMatching(JaxbManagedType jaxbManagedType) {
		if ( jaxbManagedType instanceof JaxbEntity ) {
			JaxbTenantIdImpl tenantId = ( (JaxbEntity) jaxbManagedType ).getTenantId();
