 ...
 *
 * @see IdentifierGeneratorResolver
 *
 * @author Steve Ebersole
 */
public class StrictIdentifierGeneratorResolver extends AbstractEntityIdGeneratorResolver {
	public StrictIdentifierGeneratorResolver(
	...
	private ModelsContext modelsContext() {
		return buildingContext.getModelsContext();
	}
