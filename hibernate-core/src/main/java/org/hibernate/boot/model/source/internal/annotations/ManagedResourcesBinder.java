 ...
 */
public class ManagedResourcesBinder {
	...
	public static void processAdditionalMappings(
		...
		final var context = rootMetadataBuildingContext.getBootstrapContext();
		final var builder = new AdditionalManagedResourcesImpl.Builder( context.getServiceRegistry() );
		...
		new ManagedResourcesBinder( managedResources, additionalDomainModelSource, rootMetadataBuildingContext )
				.bindEntityHierarchies( new LinkedHashSet<>() );
	}
	...
	public void bindTypeDefinitions() {
	...
	public void bindIdentifierGenerators() {
		final var collector = rootMetadataBuildingContext.getMetadataCollector();
	...
	public void bindEntityHierarchies(Set<String> processedEntityNames) {
	...
	public void bindPackageFetchProfiles() {
		for ( String annotatedModuleName : annotatedModuleNames ) {
