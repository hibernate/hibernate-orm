...
public class MapKeyMutabilityAnnotation implements MapKeyMutability {
	 ...
	 */
	public MapKeyMutabilityAnnotation(ModelsContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public MapKeyMutabilityAnnotation(MapKeyMutability annotation, ModelsContext modelContext) {
	 ...
	 */
	public MapKeyMutabilityAnnotation(Map<String, Object> attributeValues, ModelsContext modelContext) {
