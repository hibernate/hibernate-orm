...
public class NationalizedAnnotation implements Nationalized {
	 ...
	 */
	public NationalizedAnnotation(SourceModelBuildingContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public NationalizedAnnotation(Nationalized annotation, SourceModelBuildingContext modelContext) {
	}
