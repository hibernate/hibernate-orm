...
public class OverriddenSQLSelectsAnnotation
	 ...
	 */
	public OverriddenSQLSelectsAnnotation(SourceModelBuildingContext modelContext) {
	}

	/**
	 * Used in creating annotation instances from JDK variant
	 */
	public OverriddenSQLSelectsAnnotation(SQLRestrictions annotation, SourceModelBuildingContext modelContext) {
