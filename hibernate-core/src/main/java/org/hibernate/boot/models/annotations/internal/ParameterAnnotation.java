...
public class ParameterAnnotation implements Parameter {
	...
	public ParameterAnnotation(Parameter annotation, SourceModelBuildingContext modelContext) {
		this.name = extractJdkValue( annotation, HibernateAnnotations.PARAMETER, "name", modelContext );
		this.value = extractJdkValue( annotation, HibernateAnnotations.PARAMETER, "value", modelContext );
	}
