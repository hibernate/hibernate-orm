...
import org.hibernate.boot.models.mapping.internal.context.BindingHelper;
import org.hibernate.boot.models.mapping.internal.relational.InLineView;
import org.hibernate.boot.models.mapping.internal.relational.PhysicalTable;
import org.hibernate.boot.models.mapping.internal.relational.PhysicalView;
import org.hibernate.boot.models.mapping.internal.sources.ForeignKeySource;
import org.hibernate.boot.models.mapping.internal.sources.TableSource;
import org.hibernate.boot.models.mapping.internal.relational.UnionTable;
...
import org.hibernate.boot.models.mapping.internal.relational.QuotedIdentifierTarget;
...
public class TableBinder {
	...
	public List<org.hibernate.boot.models.mapping.internal.relational.SecondaryTable> bindSecondaryTables(EntityTypeBinder entityBinder) {
		...
		final List<org.hibernate.boot.models.mapping.internal.relational.SecondaryTable> result = new ArrayList<>( secondaryTableAnns.size() );
		...
		secondaryTableAnns.forEach( (secondaryTableAnn) -> {
			...
			final org.hibernate.boot.models.mapping.internal.relational.SecondaryTable binding = bindSecondaryTable( entityBinder, secondaryTableAnn, secondaryRowAnn );
			result.add( binding );
	...
	private org.hibernate.boot.models.mapping.internal.relational.SecondaryTable bindSecondaryTable(
			EntityTypeBinder entityBinder,
		...
		return new org.hibernate.boot.models.mapping.internal.relational.SecondaryTable(
				logicalName,
				catalogName,
				schemaName,
				physicalNamingStrategy.toPhysicalTableName( logicalName, jdbcEnvironment ),
