...
public class TableKeyBinder {
	...
	private org.hibernate.boot.models.mapping.internal.sources.ForeignKeySource findSecondaryTableForeignKeySource(Join join) {
		final org.hibernate.boot.models.mapping.internal.relational.SecondaryTable secondaryTable = bindingState.getSecondaryTable( join.getTable() );
