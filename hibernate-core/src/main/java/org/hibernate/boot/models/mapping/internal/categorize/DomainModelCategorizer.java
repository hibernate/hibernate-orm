...
import static org.hibernate.boot.models.mapping.internal.categorize.EntityHierarchyBuilder.createEntityHierarchies;
...
public class DomainModelCategorizer {
	...
	public static CategorizedDomainModel categorize(
		...
		final org.hibernate.boot.models.mapping.internal.xml.XmlProcessingResult xmlProcessingResult = XmlProcessor.processXml(
				xmlPreProcessingResult,
				persistenceUnitMetadata,
