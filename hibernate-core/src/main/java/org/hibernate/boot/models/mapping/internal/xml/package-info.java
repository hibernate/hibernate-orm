 ...
 * {@linkplain org.hibernate.boot.models.mapping.internal.xml.ManagedTypeProcessor} will first clear
 ...
 * <p>
 * The XML processor contracts in this package are internal pipeline contracts.
 * They are used by Hibernate boot code and are not a supported application API
 * or integrator SPI.
 *
