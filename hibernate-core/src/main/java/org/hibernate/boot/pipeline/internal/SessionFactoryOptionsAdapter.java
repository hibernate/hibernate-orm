	...
	private record Handler(
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			return switch ( method.getName() ) {
				...
				case "getEntityNotFoundDelegate" -> settings.entityNotFoundDelegate();
				...
				case "isCriteriaCopyTreeEnabled" -> settings.criteriaCopyTreeEnabled();
				...
				case "getQueryStatisticsMaxSize" -> getInt(
				...
				case "doesConnectionProviderDisableAutoCommit" -> settings.connectionProviderDisablesAutoCommit();
