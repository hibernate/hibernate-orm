...
public class MappingSettingsResolver {
	...
	public static ResolvedMappingSettings resolve(
		...
		return new ResolvedMappingSettings(
				...
				resolveShouldImplicitlyForceDiscriminatorInSelect( configurationValues ),
	...
	private static boolean resolveShouldImplicitlyForceDiscriminatorInSelect(Map<String, Object> configurationValues) {
		final Object enabled = configurationValues.get( MappingSettings.FORCE_DISCRIMINATOR_IN_SELECTS_BY_DEFAULT );
		return enabled != null && parseBoolean( enabled );
	}
