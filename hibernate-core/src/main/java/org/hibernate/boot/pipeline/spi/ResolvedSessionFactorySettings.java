...
public record ResolvedSessionFactorySettings(
		...
		/// Whether the configured connection provider already disables auto-commit.
		...
		/// Delegate used when a lazy association resolves to a missing entity.
		...
		/// Whether criteria queries are copied when creating Query objects.
	...
	public ResolvedSessionFactorySettings {
		...
		Objects.requireNonNull( entityNotFoundDelegate );
