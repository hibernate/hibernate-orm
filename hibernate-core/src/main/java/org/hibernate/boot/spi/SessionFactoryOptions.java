...
public interface SessionFactoryOptions extends QueryEngineOptions {
	/**
	 * When enabled, queries generated by the AI Assistant are validated
	 * against a restricted semantic rule set and unsafe queries are
	 * rejected before SQL is generated.
	 *
	 * @return {@code true} if AI query Safe Mode is enabled; {@code false} otherwise
	 *
	 */
