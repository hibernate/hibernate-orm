...
public class QueryKey implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if ( !EqualsHelper.areEqual( tenantIdentifier, that.tenantIdentifier ) ) {
			return false;
		}
		...
		if ( !EqualsHelper.areEqual( parameterBindingsMemento, that.parameterBindingsMemento ) ) {
			return false;
		}

		if ( !EqualsHelper.areEqual( enabledFilterNames, that.enabledFilterNames ) ) {
			return false;
		}
