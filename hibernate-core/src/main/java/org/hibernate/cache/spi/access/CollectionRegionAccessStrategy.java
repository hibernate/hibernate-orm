...
public interface CollectionRegionAccessStrategy extends RegionAccessStrategy {
	...
	/**
	 * Performs reverse operation to {@link #generateCacheKey(Object, PersistentCollectionDescriptor, SessionFactoryImplementor, String)}
	 *
	 * @param cacheKey key previously returned from {@link #generateCacheKey(Object, PersistentCollectionDescriptor, SessionFactoryImplementor, String)}
	 * @return original key passed to {@link #generateCacheKey(Object, PersistentCollectionDescriptor, SessionFactoryImplementor, String)}
	 */
