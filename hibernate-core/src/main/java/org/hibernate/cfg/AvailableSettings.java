...
public interface AvailableSettings {
	 ...
	 * that type of entity.
	 * <p/>
	 * When `true`, the entity's "where" clause will be taken into account when loading
	 * one-to-many or many-to-many collections of that type of entity.
	 * <p/>
	 * `false` (the default) indicates that the entity's "where" clause will be ignored when loading one-to-many or
