 ...
 * </ul>
 * <p>
 * We now present an example configuration file.
 *
 ...
 *
 * Hibernate no longer supports the legacy {@code hibernate.cfg.xml} format.
 * Native bootstrap code should apply settings directly via
 * {@link org.hibernate.cfg.Configuration#setProperty(String, String)} or
 * {@link org.hibernate.boot.registry.StandardServiceRegistryBuilder#applySetting(String, Object)}.
 */
