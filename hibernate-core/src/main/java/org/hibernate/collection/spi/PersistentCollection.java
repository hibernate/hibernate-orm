...
public interface PersistentCollection {
	...
	/**
	 * Is the collection provided directly to this PersistentCollection
	 * (i.e., provided as an argument to a constructor)) equivalent to the
	 * wrapped collection.
	 * <p/>
	 * Implementors that can copy elements out of a directly provided
	 * collection into the wrapped collection should override this method.
	 * <p/>
	 * @param role The collection role
	 * @return true if a collection was provided directly to this
	 * PersistentCollection, and it is equivalent to the
	 * wrapped collection; false, otherwise.
	 */
	default boolean isDirectlyProvidedCollectionEquivalentToWrappedCollection(String role) {
