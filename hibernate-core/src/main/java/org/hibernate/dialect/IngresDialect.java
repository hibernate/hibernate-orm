...
public class IngresDialect extends Dialect {
	...
	public IngresDialect() {
		...
		registerFunction( "bit_add", new StandardSqmFunctionTemplate( "bit_add" ) );
		registerFunction( "bit_and", new StandardSqmFunctionTemplate( "bit_and" ) );
		registerFunction( "bit_length", new SQLFunctionTemplate( StandardSpiBasicTypes.INTEGER, "octet_length(hex(?1))*4" ) );
		registerFunction( "bit_not", new StandardSqmFunctionTemplate( "bit_not" ) );
		registerFunction( "bit_or", new StandardSqmFunctionTemplate( "bit_or" ) );
		registerFunction( "bit_xor", new StandardSqmFunctionTemplate( "bit_xor" ) );
		registerFunction( "character_length", new StandardSqmFunctionTemplate( "character_length", StandardSpiBasicTypes.LONG ) );
		registerFunction( "charextract", new StandardSqmFunctionTemplate( "charextract", StandardSpiBasicTypes.STRING ) );
		...
		registerFunction( "dow", new StandardSqmFunctionTemplate( "dow", StandardSpiBasicTypes.STRING ) );
		...
		registerFunction( "gmt_timestamp", new StandardSqmFunctionTemplate( "gmt_timestamp", StandardSpiBasicTypes.STRING ) );
		registerFunction( "hash", new StandardSqmFunctionTemplate( "hash", StandardSpiBasicTypes.INTEGER ) );
		...
		registerFunction( "intextract", new StandardSqmFunctionTemplate( "intextract", StandardSpiBasicTypes.INTEGER ) );
		...
		registerFunction( "lowercase", new StandardSqmFunctionTemplate( "lowercase" ) );
		...
		registerFunction( "pad", new StandardSqmFunctionTemplate( "pad", StandardSpiBasicTypes.STRING ) );
		registerFunction( "position", new StandardSqmFunctionTemplate( "position", StandardSpiBasicTypes.LONG ) );
		...
		registerFunction( "squeeze", new StandardSqmFunctionTemplate( "squeeze" ) );
		...
		registerFunction( "uppercase", new StandardSqmFunctionTemplate( "uppercase" ) );
		...
		registerFunction( "uuid_create", new StandardSqmFunctionTemplate( "uuid_create", StandardSpiBasicTypes.BYTE ) );
		registerFunction( "uuid_compare", new StandardSqmFunctionTemplate( "uuid_compare", StandardSpiBasicTypes.INTEGER ) );
		registerFunction( "uuid_from_char", new StandardSqmFunctionTemplate( "uuid_from_char", StandardSpiBasicTypes.BYTE ) );
		registerFunction( "uuid_to_char", new StandardSqmFunctionTemplate( "uuid_to_char", StandardSpiBasicTypes.STRING ) );
