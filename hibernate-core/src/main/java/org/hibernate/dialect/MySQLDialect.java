...
//		registerColumnType( Types.CLOB, 65535, "text" );
		...
		registerFunction( "ord", new StandardSqmFunctionTemplate( "ord", StandardSpiBasicTypes.INTEGER ) );
		registerFunction( "quote", new StandardSqmFunctionTemplate( "quote" ) );
		...
		registerFunction( "unhex", new StandardSqmFunctionTemplate( "unhex", StandardSpiBasicTypes.STRING ) );
		...
		registerFunction( "crc32", new StandardSqmFunctionTemplate( "crc32", StandardSpiBasicTypes.LONG ) );
		...
		registerFunction( "stddev", new StandardSqmFunctionTemplate( "std", StandardSpiBasicTypes.DOUBLE) );
		...
		registerFunction( "date_format", new StandardSqmFunctionTemplate( "date_format", StandardSpiBasicTypes.STRING ) );
		...
		registerFunction( "microseconds", new StandardSqmFunctionTemplate( "microseconds", StandardSpiBasicTypes.INTEGER ) );
		...
		registerFunction( "yearweek", new StandardSqmFunctionTemplate( "yearweek", StandardSpiBasicTypes.INTEGER ) );

		registerFunction( "hex", new StandardSqmFunctionTemplate( "hex", StandardSpiBasicTypes.STRING ) );
		registerFunction( "oct", new StandardSqmFunctionTemplate( "oct", StandardSpiBasicTypes.STRING ) );
		...
		registerFunction( "encrypt", new StandardSqmFunctionTemplate( "encrypt", StandardSpiBasicTypes.STRING ) );
		registerFunction( "md5", new StandardSqmFunctionTemplate( "md5", StandardSpiBasicTypes.STRING ) );
		registerFunction( "sha1", new StandardSqmFunctionTemplate( "sha1", StandardSpiBasicTypes.STRING ) );
		registerFunction( "sha", new StandardSqmFunctionTemplate( "sha", StandardSpiBasicTypes.STRING ) );
