...
public class SQLiteDialect extends Dialect {
	...
	public SQLiteDialect() {
		...
		registerFunction( "locate", new SQLFunctionTemplate( StandardBasicTypes.INTEGER, "instr(?1, ?2)" ) );
  ...
  */
	...
	protected SqlTypeDescriptor getSqlTypeDescriptorOverride(int sqlCode) {
		switch (sqlCode) {
			case Types.BLOB:
				return BlobTypeDescriptor.BYTES_BINDING;
			case Types.CLOB:
				return ClobTypeDescriptor.STRING_CLOB_BINDING;
			default:
