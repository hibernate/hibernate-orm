...
public class H2UnnestFunction extends UnnestFunction {
	...
	protected void renderUnnest(
		...
		if ( columnReference != null ) {
			...
			super.renderUnnest( sqlAppender, array, pluralType, sqlTypedMapping, tupleType, tableIdentifierVariable,
					walker );
		}
	}
	...
	private static class H2UnnestSetReturningFunctionTypeResolver extends UnnestSetReturningFunctionTypeResolver {
		...
		@Override
		public SelectableMapping[] resolveFunctionReturnType(List<? extends SqlAstNode> arguments, String tableIdentifierVariable, TypeConfiguration typeConfiguration) {
