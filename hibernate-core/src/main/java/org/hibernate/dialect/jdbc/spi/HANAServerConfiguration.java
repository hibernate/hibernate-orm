...
/**
 * Utility class that extracts initial database configuration for
 * {@link org.hibernate.dialect.HANADialect}.
 */
public class HANAServerConfiguration {
	private static final DatabaseVersion MINIMUM_VERSION = DatabaseVersion.make( 2, 0, 50 );
