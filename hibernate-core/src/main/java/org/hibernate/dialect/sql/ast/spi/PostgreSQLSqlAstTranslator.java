...
public class PostgreSQLSqlAstTranslator<T extends JdbcOperation> extends PostgreSQLFamilySqlAstTranslator<T> {

	@SPI(SPI.Role.IMPLEMENT)
	public PostgreSQLSqlAstTranslator(SqlAstTranslationRequest<? extends Statement, T> request) {
		super( request );
	}
