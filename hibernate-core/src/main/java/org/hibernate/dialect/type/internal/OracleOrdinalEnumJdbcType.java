...
public class OracleOrdinalEnumJdbcType extends OracleEnumJdbcType {
	...
	@Override
	String[] getCreateTypeCommands(String name, String[] enumeratedValues, Dialect dialect) {
		return dialect.getEnumSupport().getCreateOrdinalTypeCommands( name, enumeratedValues );
	}
