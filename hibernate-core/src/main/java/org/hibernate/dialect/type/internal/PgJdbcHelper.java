...
public final class PgJdbcHelper {
	...
	public static JdbcType getStructJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcType( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLStructPGObjectJdbcType" );
	}

	public static JdbcType getIntervalJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcType( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLIntervalSecondJdbcType" );
	}

	public static JdbcType getInetJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcType( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLInetJdbcType" );
	}

	public static JdbcType getJsonJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcType( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLJsonPGObjectJsonType" );
	}

	public static JdbcType getJsonbJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcType( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLJsonPGObjectJsonbType" );
	}

	public static JdbcTypeConstructor getJsonArrayJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcTypeConstructor( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLJsonArrayPGObjectJsonJdbcTypeConstructor" );
	}

	public static JdbcTypeConstructor getJsonbArrayJdbcType(ServiceRegistry serviceRegistry) {
		return createJdbcTypeConstructor( serviceRegistry, "org.hibernate.dialect.type.internal.PostgreSQLJsonArrayPGObjectJsonbJdbcTypeConstructor" );
	}
