...
public class NonContextualLobCreator extends AbstractLobCreator implements LobCreator {
	...
	public Blob createBlob(byte[] bytes) {
		return BlobProxy.generateProxy( bytes, classLoaderService );
	}

	@Override
	public Blob createBlob(InputStream stream, long length) {
		return BlobProxy.generateProxy( stream, length, classLoaderService );
	}

	@Override
	public Clob createClob(String string) {
		return ClobProxy.generateProxy( string, classLoaderService );
	}

	@Override
	public Clob createClob(Reader reader, long length) {
		return ClobProxy.generateProxy( reader, length, classLoaderService );
	}

	@Override
	public NClob createNClob(String string) {
		return NClobProxy.generateProxy( string, classLoaderService );
	}

	@Override
	public NClob createNClob(Reader reader, long length) {
		return NClobProxy.generateProxy( reader, length, classLoaderService );
	}
}
