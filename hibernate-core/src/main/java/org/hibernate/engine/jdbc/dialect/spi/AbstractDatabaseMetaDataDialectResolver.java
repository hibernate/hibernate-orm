 ...
 */
public abstract class AbstractDatabaseMetaDataDialectResolver implements DatabaseMetaDataDialectResolver {
	 ...
	 */
	@Override
	public final Dialect resolve(DatabaseMetaData metaData) {
		try {
