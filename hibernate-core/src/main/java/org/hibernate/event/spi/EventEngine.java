...
public class EventEngine {
	...
	public EventEngine(
			...
			List<EventEngineContributor> explicitContributors) {
		...
		if ( CollectionHelper.isNotEmpty( explicitContributors ) ) {
			for ( int i = 0; i < explicitContributors.size(); i++ ) {
				final EventEngineContributor contributor = explicitContributors.get( i );
				contributor.contribute( contributionManager );
			}
		}
