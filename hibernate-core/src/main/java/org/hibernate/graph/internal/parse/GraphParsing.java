...
public class GraphParsing {
	...
	public static <T> RootGraphImplementor<T> parse(
			...
			GraphLanguageParser.AttributeListContext graphElementListContext,
			EntityNameResolver entityNameResolver) {

		return new LegacyGraphParsingStrategy().parse( name, rootType, graphElementListContext, entityNameResolver );
	}
	...
	public static <T> RootGraphImplementor<T> parse(
		...
		return new ModernGraphParsingStrategy().parse( name, rootType, graphElementListContext, entityNameResolver );
	}
