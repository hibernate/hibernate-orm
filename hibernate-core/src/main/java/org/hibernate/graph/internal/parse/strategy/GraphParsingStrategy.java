...
public interface GraphParsingStrategy {
	<T> RootGraphImplementor<T> parse(Class<T> entityClass, String graphText, SessionFactoryImplementor sessionFactory);
	...
	<T> RootGraphImplementor<T> parse(String entityName, String graphText, SessionFactoryImplementor sessionFactory);
