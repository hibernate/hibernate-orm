...
public final class ConfigHelper {
	 ...
	 */
	public static Reader getConfigStreamReader(final String path, ClassLoaderService classLoaderService) throws HibernateException {
		return new InputStreamReader( classLoaderService.locateResourceStream( path ) );
	}
	 ...
	 */
	public static Properties getConfigProperties(String path, ClassLoaderService classLoaderService) throws HibernateException {
		try {
			Properties properties = new Properties();
			properties.load( classLoaderService.locateResourceStream( path ) );
			return properties;
		}
		catch(IOException e) {
