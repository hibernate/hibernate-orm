...
public final class ConfigurationHelper {
	...
	public static XmlValidationMode resolveXmlValidationMode(Map<String, Object> configurationSettings) {
		...
		// If neither are set, the default is XmlValidationMode.EXTENDED
		final var validateXmlSetting = ConfigurationHelper.getBoolean( AvailableSettings.VALIDATE_XML, configurationSettings, true );
