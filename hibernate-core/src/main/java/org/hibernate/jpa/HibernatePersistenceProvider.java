...
public class HibernatePersistenceProvider implements PersistenceProvider {
	...
	public ClassTransformer getClassTransformer(PersistenceUnitInfo persistenceUnit, Map<?, ?> integrationSettings) {
		return org.hibernate.jpa.internal.enhance.ContainerEnhancement.createTransformer(
				persistenceUnit, integrationSettings, this::createEnhancementContext );
	}

	protected EnhancementContext createEnhancementContext(
			boolean dirtyTrackingEnabled,
			boolean lazyInitializationEnabled,
			boolean associationManagementEnabled,
			Map<?, ?> integrationSettings,
			PersistenceUnitInfo persistenceUnit) {
		return org.hibernate.jpa.internal.enhance.ContainerEnhancement.createEnhancementContext(
				dirtyTrackingEnabled, lazyInitializationEnabled, associationManagementEnabled, integrationSettings, persistenceUnit );
	}
