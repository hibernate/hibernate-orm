...
public class JpaComplianceImpl implements JpaCompliance {
	...
	private final boolean converterCompliance;
	...
	public JpaComplianceImpl(
		...
		this.converterCompliance = converterCompliance;
	}
	...
	public static class JpaComplianceBuilder {
		...
		public JpaComplianceBuilder setConverterCompliance(boolean converterCompliance) {
			this.converterCompliance = converterCompliance;
			return this;
		}
