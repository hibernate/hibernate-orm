...
public class LazyGroupLoader extends AbstractLoadPlanBasedEntityLoader {
	...
	private LazyGroupLoader(
		...
		super( persister, persister.getFactory() );
	...
	@Override
	protected FetchGroupLoadQueryDetails getStaticLoadQuery() {
		return staticLoadQuery;
	}

	public String getSqlStatement() {
		return staticLoadQuery.getSqlStatement();
	}
	...
	public static class FetchGroupLoadQueryDetails extends EntityLoadQueryDetails {
		...
		protected void applyRootReturnSelectFragments(SelectStatementBuilder selectStatementBuilder) {
			...
			String propertyFragment = ( ( AbstractEntityPersister) queryable ).lazyGroupSelectFragment(
					entityReferenceAliases.getTableAlias(),
					entityReferenceAliases.getColumnAliases().getSuffix(),
