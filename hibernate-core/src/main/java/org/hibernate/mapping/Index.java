	...
	public static String buildSqlCreateIndexString(
		...
		while (columns.hasNext()) {
			...
			if (columnOrderMap.containsKey(column)) {
				colBuf.append(" ").append(columnOrderMap.get(column));
			}
			if (columns.hasNext()) colBuf.append(", ");
		}
		...
		StringBuilder buf = new StringBuilder( "create" )
				...
				.append(dialect.isColumnNameRequiredAfterIndex() ? null : colBuf)
				.append( " on " )
				.append( tableName );

		if (!dialect.isColumnNameRequiredAfterIndex())
			buf.append(colBuf);
		return buf.toString();
	}
