...
public class SimpleValue implements KeyValue {
	...
	private Type buildAttributeConverterTypeAdapter() {
		...
		final SqlTypeDescriptor sqlTypeDescriptor = metadata.getTypeDescriptorRegistryAccess().getSqlTypeDescriptorRegistry().getDescriptor( jdbcTypeCode );
		...
		final JavaTypeDescriptor intermediateJavaTypeDescriptor = metadata.getTypeDescriptorRegistryAccess().getJavaTypeDescriptorRegistry().getDescriptor( databaseColumnJavaType );
