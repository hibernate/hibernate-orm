...
/**
 * Describes any type that occurs in the application's (mapped) domain model.
 * Also acts as the base for Hibernate's extension of the JPA type system.
 *
 ...
 *
 * @apiNote The "real" JPA type system is more akin to Hibernate's
 * {@link SimpleDomainType}.  This contract represents a "higher level" construct
