...
public class FetchProfileBinder {
    ...
    /**
     * Binds all {@link org.hibernate.annotations.FetchProfiles} and {@link org.hibernate.annotations.FetchProfile} annotations to
     * the specified meta data instance.
     *
    ...
    public static void bind( MetadataImpl meta,
                             Index index ) {
        // check @FetchProfiles
        ...
        for (AnnotationInstance fetchProfilesAnnotation : fetchProfilesAnnotations) {
            ...
            bind(meta, Arrays.asList(fetchProfiles));
        }
        // check @FetchProfile
        List<AnnotationInstance> fetchProfileAnnotations = index.getAnnotations(HibernateDotNames.FETCH_PROFILE);
        bind(meta, fetchProfileAnnotations);
    }

    private static void bind( MetadataImpl meta,
                              List<AnnotationInstance> fetchProfileAnnotations ) {
