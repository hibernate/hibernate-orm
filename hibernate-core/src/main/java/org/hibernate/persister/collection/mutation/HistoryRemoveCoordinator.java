...
/**
 * Remove coordinator for HISTORY temporal collection tables.
 */
public class HistoryRemoveCoordinator implements RemoveCoordinator {
	...
	public HistoryRemoveCoordinator(
