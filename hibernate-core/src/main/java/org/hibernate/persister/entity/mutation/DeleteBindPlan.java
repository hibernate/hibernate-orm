...
public class DeleteBindPlan implements BindPlan {
	...
	public void execute(
			...
			SharedSessionContractImplementor session) {
		executor.execute(
				null,  // entity instance not needed for delete
				null,  // valuesAnalysis not needed for delete
				null,  // tableInclusionChecker not needed for delete
				DeleteBindPlan::verifyOutcome,
				session
		);
	}

	protected void decomposeForDelete(
