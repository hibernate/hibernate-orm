...
public class HibernateCriteriaBuilderDelegate implements HibernateCriteriaBuilder {
	...
	@Override
	@Incubating
	public <T> JpaExpression<List<T>> collectionReverse(Expression<? extends Collection<T>> collectionExpression) {
		return criteriaBuilder.collectionReverse( collectionExpression );
	}

	@Override
	@Incubating
	public <T> JpaExpression<List<T>> collectionSort(Expression<? extends Collection<T>> collectionExpression) {
		return criteriaBuilder.collectionSort( collectionExpression );
	}

	@Override
	@Incubating
	public <T> JpaExpression<List<T>> collectionSort(
			Expression<? extends Collection<T>> collectionExpression,
			boolean descending) {
