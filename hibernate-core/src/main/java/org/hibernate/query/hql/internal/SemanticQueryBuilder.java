...
//		}
		...
		if ( template == null ) {
			...
			return template.makeSqmFunctionExpression(
					...
					castTargetExpression.getExpressableType()
			);
		}
	}
	...
	private SqmCastTarget interpretCastTarget(HqlParser.CastTargetContext castTargetContext) {
		...
		switch (text.toLowerCase()) {
			case "string": return new SqmCastTarget(StandardSpiBasicTypes.STRING);
			case "integer": return new SqmCastTarget(StandardSpiBasicTypes.INTEGER);
			case "long": return new SqmCastTarget(StandardSpiBasicTypes.LONG);
			case "float": return new SqmCastTarget(StandardSpiBasicTypes.FLOAT);
			case "double": return new SqmCastTarget(StandardSpiBasicTypes.DOUBLE);
			case "time": return new SqmCastTarget(StandardSpiBasicTypes.TIME);
			case "date": return new SqmCastTarget(StandardSpiBasicTypes.DATE);
			case "timestamp": return new SqmCastTarget(StandardSpiBasicTypes.TIMESTAMP);
