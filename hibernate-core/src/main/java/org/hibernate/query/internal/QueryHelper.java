...
public class QueryHelper {
	...
	@SafeVarargs
	public static <T> SqmBindable<? extends T> highestPrecedenceType(SqmBindable<? extends T>... types) {
	...
	public static <X> SqmBindable<? extends X> highestPrecedenceType2(
			SqmBindable<? extends X> type1,
			SqmBindable<? extends X> type2) {
