 ...
 */
public class EntityResultImpl<E> implements EntityResult<E>, InitializerProducer<EntityResultImpl<E>> {
	...
	public EntityResultImpl(
			...
			String resultAlias,
			LockMode lockMode,
			Function<EntityResultImpl<E>, BasicFetch<?>> discriminatorFetchBuilder,
