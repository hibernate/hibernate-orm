...
public class SqmCriteriaNodeBuilder implements NodeBuilder, Serializable {
	...
	@Override
	public <T> JpaParameterExpression<List<T>> listParameter(Class<T> paramClass, @Nullable String name) {
...
//			|| is a literal enum mapped to a PostgreSQL named 'enum' type
	...
	@Override
	public <T> SqmExpression<List<T>> collectionReverse(Expression<? extends Collection<T>> collectionExpression) {
		return getFunctionDescriptor( "array_reverse" ).generateSqmExpression(
				Collections.singletonList( (SqmExpression<?>) collectionExpression ),
				null,
				queryEngine
	...
	@Override
	public <T> SqmExpression<List<T>> collectionSort(Expression<? extends Collection<T>> collectionExpression) {
		return getFunctionDescriptor( "array_sort" ).generateSqmExpression(
				Collections.singletonList( (SqmExpression<?>) collectionExpression ),
				null,
				queryEngine
	...
	@Override
	public <T> SqmExpression<List<T>> collectionSort(
