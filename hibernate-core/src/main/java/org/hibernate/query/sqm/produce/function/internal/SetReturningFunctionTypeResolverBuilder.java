...
public class SetReturningFunctionTypeResolverBuilder implements SetReturningFunctionTypeResolver.Builder {
	...
	private static class SetReturningFunctionTypeResolverImpl implements SetReturningFunctionTypeResolver {
		...
		public AnonymousTupleType<?> resolveTupleType(List<? extends SqmTypedNode<?>> arguments, TypeConfiguration typeConfiguration) {
			final SqmExpressible<?>[] componentTypes = new SqmExpressible[typeResolvers.length];
			final String[] componentNames = new String[typeResolvers.length];
			int i = 0;
		...
		public SelectableMapping[] resolveFunctionReturnType(List<? extends SqlAstNode> arguments, String tableIdentifierVariable, TypeConfiguration typeConfiguration) {
			final SelectableMapping[] selectableMappings = new SelectableMapping[typeResolvers.length];
			int i = 0;
			for ( TypeResolver typeResolver : typeResolvers ) {
