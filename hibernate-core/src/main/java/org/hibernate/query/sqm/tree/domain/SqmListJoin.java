...
public class SqmListJoin<O,E> extends AbstractSqmPluralJoin<O,List<E>, E> implements JpaListJoin<O, E> {
	...
	public ListPersistentAttribute getReferencedNavigable() {
		return (ListPersistentAttribute) super.getReferencedNavigable();
	}
	...
	public SqmPath<Integer> index() {
		return new SqmBasicValuedSimplePath<>(
				...
				(BasicValuedNavigable<Integer>) getReferencedNavigable().getCollectionDescriptor().getIndexDescriptor(),
				this,
				nodeBuilder()
		);
	}
