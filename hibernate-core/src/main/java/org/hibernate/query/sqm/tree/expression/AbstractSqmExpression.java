...
public abstract class AbstractSqmExpression<T> extends AbstractJpaSelection<T> implements SqmExpression<T> {
	...
	public AbstractSqmExpression(@Nullable SqmBindable<? super T> type, NodeBuilder criteriaBuilder) {
	...
	protected void internalApplyInferableType(@Nullable SqmBindable<?> newType) {
