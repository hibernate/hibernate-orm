...
public class SqmCaseSearched<R>
	...
	public SqmCaseSearched(SqmBindable<R> inherentType, NodeBuilder nodeBuilder) {
	...
	private SqmCaseSearched(SqmBindable<R> inherentType, int estimatedWhenSize, NodeBuilder nodeBuilder) {
