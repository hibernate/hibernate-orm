...
public class SqmLiteral<T> extends AbstractSqmExpression<T> {
	...
	public SqmLiteral(T value, SqmBindable<? super T> inherentType, NodeBuilder nodeBuilder) {
	...
	protected SqmLiteral(SqmBindable<T> inherentType, NodeBuilder nodeBuilder) {
		super( inherentType, nodeBuilder );
		this.value = null;
	}
