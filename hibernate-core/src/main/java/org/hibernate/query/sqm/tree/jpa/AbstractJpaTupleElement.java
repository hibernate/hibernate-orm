...
public abstract class AbstractJpaTupleElement<T>
	...
	private @Nullable SqmBindable<T> expressibleType;
	private @Nullable String alias;

	protected AbstractJpaTupleElement(@Nullable SqmBindable<? super T> expressibleType, NodeBuilder criteriaBuilder) {
	...
	protected final void setExpressibleType(@Nullable SqmBindable<?> expressibleType) {
		//noinspection unchecked
		this.expressibleType = (SqmBindable<T>) expressibleType;
	}
