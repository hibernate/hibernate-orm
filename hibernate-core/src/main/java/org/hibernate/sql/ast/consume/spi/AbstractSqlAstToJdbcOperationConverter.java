 ...
 */
public class AbstractSqlAstToJdbcOperationConverter implements SqlAstToJdbcOperationConverter {
	// pre-req state
	...
	public AbstractSqlAstToJdbcOperationConverter(
			SharedSessionContractImplementor persistenceContext,
			QueryParameterBindings parameterBindings, Collection<?> loadIdentifiers) {
