...
public class OrderByFragmentParser extends GeneratedOrderByFragmentParser {
	...
	protected boolean isFunctionName(AST ast) {
		...
		final SqmFunctionTemplate function = context.getSqlFunctionRegistry().findFunctionTemplate( ast.getText() );
		if ( function == null ) {
	...
	protected AST resolveFunction(AST ast) {
		...
		final SqmFunctionTemplate function = context.getSqlFunctionRegistry().findFunctionTemplate( functionName );
		if ( function == null ) {
