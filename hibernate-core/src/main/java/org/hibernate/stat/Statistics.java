...
public interface Statistics {
    ...
    /**
	 * Find the statistics pertaining to a given entity by name
	 * 
	...
	/**
	 * Find the statistics pertaining to a given entity by role
	 * 
	...
	/**
	 * Find the statistics pertaining to a given natural-id (identified by entity name)
	 *
	 * @param entityName the entity name
	 * @return NaturalIdCacheStatistics
	 */
	NaturalIdQueryStatistics getNaturalIdStatistics(String entityName);

    /**
	 * Find the statistics pertaining to a "data cache region" (entity,
	 * collection, natural-id data), query-result region or timestamps
