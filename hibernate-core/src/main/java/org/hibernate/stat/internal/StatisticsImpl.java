...
public class StatisticsImpl implements StatisticsImplementor, Service, Manageable {
	...
	private final StatsConcurrentHashMap<EntityStatisticsImpl> entityStatsMap = new StatsConcurrentHashMap();
	private final StatsConcurrentHashMap<NaturalIdStatisticsImpl> naturalIdQueryStatsMap = new StatsConcurrentHashMap();
	private final StatsConcurrentHashMap<CollectionStatisticsImpl> collectionStatsMap = new StatsConcurrentHashMap();

	/**
	 * Keyed by query string
	 */
	private final StatsConcurrentHashMap<QueryStatisticsImpl> queryStatsMap;

	/**
	 * Keyed by region name
	 */
	private final StatsConcurrentHashMap<CacheRegionStatisticsImpl> l2CacheStatsMap = new StatsConcurrentHashMap<>();

	private final StatsConcurrentHashMap<DeprecatedNaturalIdCacheStatisticsImpl> deprecatedNaturalIdStatsMap = new StatsConcurrentHashMap();
	...
	public StatisticsImpl(SessionFactoryImplementor sessionFactory) {
		...
		this.queryStatsMap = new StatsConcurrentHashMap(
				sessionFactory != null ?
