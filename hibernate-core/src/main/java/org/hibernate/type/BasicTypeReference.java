...
public final class BasicTypeReference<T> implements BindableType<T>, Serializable {
	...
	@Override
	public SqmExpressible<T> resolveExpressible(SqmCreationContext creationContext) {
		return creationContext.getTypeConfiguration().getBasicTypeRegistry().resolve( this );
	}
}
