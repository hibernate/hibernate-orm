...
public abstract class CollectionType extends AbstractType implements AssociationType {
	...
	public Object resolve(Object value, SharedSessionContractImplementor session, Object owner, Boolean eager) throws HibernateException {
		return resolveKey( getKeyOfOwner( owner, session ), session, owner, eager );
	}

	private Object resolveKey(Serializable key, SharedSessionContractImplementor session, Object owner, Boolean eager) {
		...
		return key == null ? null : // TODO: can this case really occur??
			getCollection( key, session, owner, eager );
	}
	 ...
	 */
	public Object getCollection(Serializable key, SharedSessionContractImplementor session, Object owner, Boolean eager) {
		...
		if ( collection == null ) {
			...
			if ( collection == null ) {
				...
				if ( collection == null ) {
					...
					boolean finalEager = eager != null ? eager : !persister.isLazy();
