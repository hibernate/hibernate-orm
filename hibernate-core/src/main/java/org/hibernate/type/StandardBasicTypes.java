...
public final class StandardBasicTypes {
	...
	/**
	 * The public contract for the types defined here.
	 *
	 * @apiNote extends all the things needed to use this in most API calls
	 */
	public interface StandardBasicType<J>
			extends BasicDomainType<J>, AllowableParameterType<J>, AllowableFunctionReturnType<J> {
	 ...
	 */
	public static final StandardBasicType<Boolean> BOOLEAN = StandardSpiBasicTypes.BOOLEAN;


	/**
	 * The standard Hibernate type for mapping {@link Boolean} to JDBC {@link java.sql.Types#INTEGER INTEGER}.
	 */
	public static final StandardBasicType<Boolean> NUMERIC_BOOLEAN = StandardSpiBasicTypes.NUMERIC_BOOLEAN;

	/**
	 * The standard Hibernate type for mapping {@link Boolean} to JDBC {@link java.sql.Types#CHAR CHAR(1)} (using 'T'/'F').
	 */
	public static final StandardBasicType<Boolean> TRUE_FALSE = StandardSpiBasicTypes.TRUE_FALSE;

	/**
	 * The standard Hibernate type for mapping {@link Boolean} to JDBC {@link java.sql.Types#CHAR CHAR(1)} (using 'Y'/'N').
	 */
	public static final StandardBasicType<Boolean> YES_NO = StandardSpiBasicTypes.YES_NO;
	 ...
	 */
	public static final StandardBasicType<Byte> BYTE = StandardSpiBasicTypes.BYTE;

	/**
	 * The standard Hibernate type for mapping {@code byte[]} to JDBC {@link java.sql.Types#VARBINARY VARBINARY}.
	 */
	public static final StandardBasicType<byte[]> BINARY = StandardSpiBasicTypes.BINARY;

	/**
	 * The standard Hibernate type for mapping {@link Byte Byte[]} to JDBC {@link java.sql.Types#VARBINARY VARBINARY}.
	 */
	public static final StandardBasicType<Byte[]> WRAPPER_BINARY = StandardSpiBasicTypes.WRAPPER_BINARY;
	 ...
	 */
	public static final StandardBasicType<byte[]> IMAGE = StandardSpiBasicTypes.IMAGE;
	 ...
	 * @see #MATERIALIZED_BLOB
	 */
	public static final StandardBasicType<Blob> BLOB = StandardSpiBasicTypes.BLOB;
	 ...
	 * @see #IMAGE
	 */
	public static final StandardBasicType<byte[]> MATERIALIZED_BLOB = StandardSpiBasicTypes.MATERIALIZED_BLOB;
	 ...
	 */
	public static final StandardBasicType<Short> SHORT = StandardSpiBasicTypes.SHORT;

	/**
	 * The standard Hibernate type for mapping {@link Integer} to JDBC {@link java.sql.Types#INTEGER INTEGER}.
	 */
	public static final StandardBasicType<Integer> INTEGER = StandardSpiBasicTypes.INTEGER;

	/**
	 * The standard Hibernate type for mapping {@link Long} to JDBC {@link java.sql.Types#BIGINT BIGINT}.
	 */
	public static final StandardBasicType<Long> LONG = StandardSpiBasicTypes.LONG;
	 ...
	 */
	public static final StandardBasicType<BigInteger> BIG_INTEGER = StandardSpiBasicTypes.BIG_INTEGER;

	/**
	 * The standard Hibernate type for mapping {@link java.math.BigDecimal} to JDBC {@link java.sql.Types#NUMERIC NUMERIC}.
	 */
	public static final StandardBasicType<BigDecimal> BIG_DECIMAL = StandardSpiBasicTypes.BIG_DECIMAL;
	 ...
	 */
	public static final StandardBasicType<Character> CHARACTER = StandardSpiBasicTypes.CHARACTER;

	/**
	 * The standard Hibernate type for mapping {@link Character} to JDBC {@link java.sql.Types#NCHAR NCHAR(1)}.
	 */
	public static final StandardBasicType<Character> CHARACTER_NCHAR = StandardSpiBasicTypes.CHARACTER_NCHAR;

	/**
	 * The standard Hibernate type for mapping {@link String} to JDBC {@link java.sql.Types#VARCHAR VARCHAR}.
	 */
	public static final StandardBasicType<String> STRING = StandardSpiBasicTypes.STRING;

	/**
	 * The standard Hibernate type for mapping {@link String} to JDBC {@link java.sql.Types#NVARCHAR NVARCHAR}.
	 */
	public static final StandardBasicType<String> NSTRING = StandardSpiBasicTypes.NSTRING;

	/**
	 * The standard Hibernate type for mapping {@code char[]} to JDBC {@link java.sql.Types#VARCHAR VARCHAR}.
	 */
	public static final StandardBasicType<char[]> CHAR_ARRAY = StandardSpiBasicTypes.CHAR_ARRAY;

	/**
	 * The standard Hibernate type for mapping {@link Character Character[]} to JDBC
	 * {@link java.sql.Types#VARCHAR VARCHAR}.
	 */
	public static final StandardBasicType<Character[]> CHARACTER_ARRAY = StandardSpiBasicTypes.CHARACTER_ARRAY;
	 ...
	 */
	public static final StandardBasicType<String> TEXT = StandardSpiBasicTypes.TEXT;
	 ...
	 */
	public static final StandardBasicType<String> NTEXT = StandardSpiBasicTypes.NTEXT;
	 ...
	 */
	public static final StandardBasicType<Clob> CLOB = StandardSpiBasicTypes.CLOB;
	 ...
	 */
	public static final StandardBasicType<NClob> NCLOB = StandardSpiBasicTypes.NCLOB;
	 ...
	 * @see #TEXT
	 */
	public static final StandardBasicType<String> MATERIALIZED_CLOB = StandardSpiBasicTypes.MATERIALIZED_CLOB;
	 ...
	 * @see #MATERIALIZED_BLOB
	 */
	public static final StandardBasicType<byte[]> WRAPPED_MATERIALIZED_BLOB = StandardSpiBasicTypes.WRAPPED_MATERIALIZED_BLOB;
	 ...
	 * @see #CHAR_ARRAY
	 */
	public static final StandardBasicType<Character[]> MATERIALIZED_NCLOB_CHARACTER_ARRAY = StandardSpiBasicTypes.MATERIALIZED_NCLOB_CHARACTER_ARRAY;
	 ...
	 * @see #TEXT
	 */
	public static final StandardBasicType<String> MATERIALIZED_CLOB_CHAR_ARRAY = StandardSpiBasicTypes.MATERIALIZED_CLOB_CHAR_ARRAY;
	 ...
	 * @see #TEXT
	 */
	public static final StandardBasicType<String> MATERIALIZED_CLOB_CHARACTER_ARRAY = StandardSpiBasicTypes.MATERIALIZED_CLOB_CHARACTER_ARRAY;
	 ...
	 * @see #TEXT
	 */
	public static final StandardBasicType<String> MATERIALIZED_NCLOB_CHAR_ARRAY = StandardSpiBasicTypes.MATERIALIZED_NCLOB_CHAR_ARRAY;
	 ...
	 * @see #NTEXT
	 */
	public static final StandardBasicType<String> MATERIALIZED_NCLOB = StandardSpiBasicTypes.MATERIALIZED_NCLOB;
	 ...
	 */
	public static final StandardBasicType<Duration> DURATION = StandardSpiBasicTypes.DURATION;

	/**
	 * The standard Hibernate type for mapping {@link LocalDateTime} to JDBC {@link java.sql.Types#TIMESTAMP TIMESTAMP}.
	 */
	public static final StandardBasicType<LocalDateTime> LOCAL_DATE_TIME = StandardSpiBasicTypes.LOCAL_DATE_TIME;

	/**
	 * The standard Hibernate type for mapping {@link LocalDate} to JDBC {@link java.sql.Types#DATE DATE}.
	 */
	public static final StandardBasicType<LocalDate> LOCAL_DATE = StandardSpiBasicTypes.LOCAL_DATE;

	/**
	 * The standard Hibernate type for mapping {@link LocalTime} to JDBC {@link java.sql.Types#TIME TIME}.
	 */
	public static final StandardBasicType<LocalTime> LOCAL_TIME = StandardSpiBasicTypes.LOCAL_TIME;

	/**
	 * The standard Hibernate type for mapping {@link OffsetDateTime} to JDBC {@link java.sql.Types#TIMESTAMP TIMESTAMP}.
	 */
	public static final StandardBasicType<OffsetDateTime> OFFSET_DATE_TIME = StandardSpiBasicTypes.OFFSET_DATE_TIME;

	/**
	 * The standard Hibernate type for mapping {@link OffsetTime} to JDBC {@link java.sql.Types#TIME TIME}.
	 */
	public static final StandardBasicType<OffsetTime> OFFSET_TIME = StandardSpiBasicTypes.OFFSET_TIME;

	/**
	 * The standard Hibernate type for mapping {@link ZonedDateTime} to JDBC {@link java.sql.Types#TIMESTAMP TIMESTAMP}.
	 */
	public static final StandardBasicType<ZonedDateTime> ZONED_DATE_TIME = StandardSpiBasicTypes.ZONED_DATE_TIME;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Date} ({@link java.sql.Time}) to JDBC
	 * {@link java.sql.Types#TIME TIME}.
	 */
	public static final StandardBasicType<Date> TIME = StandardSpiBasicTypes.TIME;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Date} ({@link java.sql.Date}) to JDBC
	 * {@link java.sql.Types#DATE DATE}.
	 */
	public static final StandardBasicType<Date> DATE = StandardSpiBasicTypes.DATE;
	 ...
	 */
	public static final StandardBasicType<Date> TIMESTAMP = StandardSpiBasicTypes.TIMESTAMP;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Calendar} to JDBC
	 * {@link java.sql.Types#TIMESTAMP TIMESTAMP}.
	 */
	public static final StandardBasicType<Calendar> CALENDAR = StandardSpiBasicTypes.CALENDAR;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Calendar} to JDBC
	 * {@link java.sql.Types#DATE DATE}.
	 */
	public static final StandardBasicType<Calendar> CALENDAR_DATE = StandardSpiBasicTypes.CALENDAR_DATE;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Calendar} to JDBC
	 * {@link java.sql.Types#TIME TIME}.
	 */
	public static final StandardBasicType<Calendar> CALENDAR_TIME = StandardSpiBasicTypes.CALENDAR_TIME;

	/**
	 * The standard Hibernate type for mapping {@link Instant} to JDBC
	 * {@link java.sql.Types#TIMESTAMP TIMESTAMP}.
	 */
	public static final StandardBasicType<Instant> INSTANT = StandardSpiBasicTypes.INSTANT;
	 ...
	 */
	public static final StandardBasicType<UUID> UUID_BINARY = StandardSpiBasicTypes.UUID_BINARY;


	/**
	 * The standard Hibernate type for mapping {@link java.util.UUID} to JDBC {@link java.sql.Types#CHAR CHAR}.
	 */
	public static final StandardBasicType<UUID> UUID_CHAR = StandardSpiBasicTypes.UUID_CHAR;
	 ...
	 */
	public static final StandardBasicType<Class> CLASS = StandardSpiBasicTypes.CLASS;


	/**
	 * The standard Hibernate type for mapping {@link java.util.Currency} to JDBC {@link java.sql.Types#VARCHAR VARCHAR}.
	 */
	public static final StandardBasicType<Currency> CURRENCY = StandardSpiBasicTypes.CURRENCY;

	/**
	 * The standard Hibernate type for mapping {@link java.util.Locale} to JDBC {@link java.sql.Types#VARCHAR VARCHAR}.
	 */
	public static final StandardBasicType<Locale> LOCALE = StandardSpiBasicTypes.LOCALE;

	/**
	 * The standard Hibernate type for mapping {@link java.io.Serializable} to JDBC {@link java.sql.Types#VARBINARY VARBINARY}.
	 */
	public static final StandardBasicType<Serializable> SERIALIZABLE = StandardSpiBasicTypes.SERIALIZABLE;
	 ...
	 */
	public static final StandardBasicType<java.net.URL> URL = StandardSpiBasicTypes.URL;
