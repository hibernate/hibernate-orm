...
import org.hibernate.type.descriptor.sql.TimestampWithTimeZoneTypeDescriptor;

/**
 * A type that maps between {@link java.sql.Types#TIMESTAMP_WITH_TIMEZONE TIMESTAMP_WITH_TIMEZONE} and {@link OffsetDateTime}
 *
...
public class TimestampWithTimeZoneType
	...
	public static final TimestampWithTimeZoneType INSTANCE = new TimestampWithTimeZoneType();
	...
	public TimestampWithTimeZoneType() {
		super( TimestampWithTimeZoneTypeDescriptor.INSTANCE, OffsetDateTimeJavaDescriptor.INSTANCE );
	}
