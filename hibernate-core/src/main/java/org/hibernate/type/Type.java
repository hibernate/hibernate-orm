...
public interface Type extends Serializable {
	 ...
	 *
	 * @param mapping The TypeConfiguration  {#{@link TypeConfiguration}}
	 *
	 * @return The number of columns
	 *
	 * @throws MappingException Generally indicates an issue accessing the passed mapping object.
	 * @deprecated use {@link #getColumnSpan(TypeConfiguration)}
	 */
	 ...
	 *
	 * @return array indicating column nullness for a value instance
	 * @deprecated use {@link #toColumnNullness(Object, TypeConfiguration)}
	 */
	@Deprecated(since = "7.0")
