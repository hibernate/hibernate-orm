...
public class AttributeConverterJdbcTypeDescriptorAdapter implements JdbcTypeDescriptor {
	private static final Logger log = Logger.getLogger( AttributeConverterJdbcTypeDescriptorAdapter.class );
