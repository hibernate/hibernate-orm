...
public abstract class AbstractJavaTypeDescriptor<T> implements BasicJavaType<T>, Serializable {
	 ...
	 *
	 * @see #AbstractJavaTypeDescriptor(Type, MutabilityPlan)
	 */
	@SuppressWarnings({ "unchecked" })
	protected AbstractJavaTypeDescriptor(Type type) {
	 ...
	 */
	@SuppressWarnings({ "unchecked" })
	protected AbstractJavaTypeDescriptor(Type type, MutabilityPlan<T> mutabilityPlan) {
		this.type = type;
