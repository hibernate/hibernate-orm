 ...
 */
public class BigIntegerJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<BigInteger> {
	public static final BigIntegerJavaTypeDescriptor INSTANCE = new BigIntegerJavaTypeDescriptor();

	public BigIntegerJavaTypeDescriptor() {
