 ...
 * @author Brett Meyer
 */
public class BlobJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<Blob> {
	public static final BlobJavaTypeDescriptor INSTANCE = new BlobJavaTypeDescriptor();
	...
	public String toString(Blob value) {
		...
		return PrimitiveByteArrayJavaTypeDescriptor.INSTANCE.toString( bytes );
	}

	@Override
	public Blob fromString(CharSequence string) {
		return BlobProxy.generateProxy( PrimitiveByteArrayJavaTypeDescriptor.INSTANCE.fromString( string ) );
	}
