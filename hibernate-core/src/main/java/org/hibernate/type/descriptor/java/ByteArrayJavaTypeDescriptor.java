 ...
 */
public class ByteArrayJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<Byte[]> {
	public static final ByteArrayJavaTypeDescriptor INSTANCE = new ByteArrayJavaTypeDescriptor();
