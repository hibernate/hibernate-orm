 ...
 */
public class CharacterArrayJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<Character[]> {
	public static final CharacterArrayJavaTypeDescriptor INSTANCE = new CharacterArrayJavaTypeDescriptor();
