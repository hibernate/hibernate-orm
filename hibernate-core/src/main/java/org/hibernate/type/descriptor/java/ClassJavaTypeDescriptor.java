 ...
 */
public class ClassJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<Class> {
	public static final ClassJavaTypeDescriptor INSTANCE = new ClassJavaTypeDescriptor();

	public ClassJavaTypeDescriptor() {
		super( Class.class );
	}
