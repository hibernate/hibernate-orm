 ...
 */
public class LocalTimeJavaTypeDescriptor extends AbstractTemporalJavaTypeDescriptor<LocalTime> {
	/**
	 * Singleton access
	 */
	public static final LocalTimeJavaTypeDescriptor INSTANCE = new LocalTimeJavaTypeDescriptor();

	@SuppressWarnings("unchecked")
	public LocalTimeJavaTypeDescriptor() {
