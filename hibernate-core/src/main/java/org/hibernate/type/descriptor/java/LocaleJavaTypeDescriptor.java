 ...
 */
public class LocaleJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<Locale> {
	public static final LocaleJavaTypeDescriptor INSTANCE = new LocaleJavaTypeDescriptor();
