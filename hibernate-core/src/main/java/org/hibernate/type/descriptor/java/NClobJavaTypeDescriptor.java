 ...
 */
public class NClobJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<NClob> {
	public static final NClobJavaTypeDescriptor INSTANCE = new NClobJavaTypeDescriptor();
