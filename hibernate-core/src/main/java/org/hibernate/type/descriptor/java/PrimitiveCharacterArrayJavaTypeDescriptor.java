 ...
 */
public class PrimitiveCharacterArrayJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<char[]> {
	public static final PrimitiveCharacterArrayJavaTypeDescriptor INSTANCE = new PrimitiveCharacterArrayJavaTypeDescriptor();
