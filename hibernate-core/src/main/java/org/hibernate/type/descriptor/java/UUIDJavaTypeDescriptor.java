 ...
 */
public class UUIDJavaTypeDescriptor extends AbstractClassJavaTypeDescriptor<UUID> {
	public static final UUIDJavaTypeDescriptor INSTANCE = new UUIDJavaTypeDescriptor();

	public UUIDJavaTypeDescriptor() {
		super( UUID.class );
	}
