...
/**
 * EntityJavaTypeDescriptor uses object identity for equals/hashCode as we ensure that internally.
 *
 * @author Christian Beikov
 */
public class EntityJavaTypeDescriptor<T> extends AbstractClassJavaTypeDescriptor<T> {

	public EntityJavaTypeDescriptor(Class<T> type, MutabilityPlan<T> mutabilityPlan) {
	...
	public String toString() {
		return "EntityJavaTypeDescriptor(" + getJavaType().getTypeName() + ")";
	}
}
