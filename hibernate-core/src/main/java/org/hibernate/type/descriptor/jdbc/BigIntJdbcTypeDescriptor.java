 ...
 */
public class BigIntJdbcTypeDescriptor implements JdbcTypeDescriptor {
	public static final BigIntJdbcTypeDescriptor INSTANCE = new BigIntJdbcTypeDescriptor();

	public BigIntJdbcTypeDescriptor() {
	}
	...
	public <T> BasicJavaTypeDescriptor<T> getJdbcRecommendedJavaTypeMapping(
		...
		return (BasicJavaTypeDescriptor<T>) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( Long.class );
	}
