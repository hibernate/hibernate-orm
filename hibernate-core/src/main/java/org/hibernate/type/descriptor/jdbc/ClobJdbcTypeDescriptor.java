 ...
 * @author Gail Badner
 */
public abstract class ClobJdbcTypeDescriptor implements AdjustableJdbcTypeDescriptor {
	@Override
	...
	public static final ClobJdbcTypeDescriptor DEFAULT = new ClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final ClobJdbcTypeDescriptor STRING_BINDING = new ClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final ClobJdbcTypeDescriptor CLOB_BINDING = new ClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final ClobJdbcTypeDescriptor STREAM_BINDING = new ClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final ClobJdbcTypeDescriptor STREAM_BINDING_EXTRACTING = new ClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
