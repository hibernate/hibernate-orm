 ...
 */
public class DoubleJdbcTypeDescriptor implements JdbcTypeDescriptor {
	public static final DoubleJdbcTypeDescriptor INSTANCE = new DoubleJdbcTypeDescriptor();

	public DoubleJdbcTypeDescriptor() {
	}
