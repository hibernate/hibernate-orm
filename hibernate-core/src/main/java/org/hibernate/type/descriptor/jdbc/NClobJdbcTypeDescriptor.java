 ...
 * @author Gail Badner
 */
public abstract class NClobJdbcTypeDescriptor implements JdbcTypeDescriptor {
	@Override
	...
	public static final NClobJdbcTypeDescriptor DEFAULT = new NClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final NClobJdbcTypeDescriptor NCLOB_BINDING = new NClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
	...
	public static final NClobJdbcTypeDescriptor STREAM_BINDING = new NClobJdbcTypeDescriptor() {
		@Override
		public String toString() {
