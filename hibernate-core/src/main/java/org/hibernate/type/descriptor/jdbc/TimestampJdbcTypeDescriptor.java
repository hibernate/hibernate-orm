 ...
 */
public class TimestampJdbcTypeDescriptor implements JdbcTypeDescriptor {
	public static final TimestampJdbcTypeDescriptor INSTANCE = new TimestampJdbcTypeDescriptor();

	public TimestampJdbcTypeDescriptor() {
	}
	...
	public <T> BasicJavaTypeDescriptor<T> getJdbcRecommendedJavaTypeMapping(
		...
		return (BasicJavaTypeDescriptor<T>) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( Timestamp.class );
	}
