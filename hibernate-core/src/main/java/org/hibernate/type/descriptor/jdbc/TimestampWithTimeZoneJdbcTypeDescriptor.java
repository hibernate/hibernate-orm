 ...
 * @author Gavin King
 */
public class TimestampWithTimeZoneJdbcTypeDescriptor implements JdbcTypeDescriptor {
	public static final TimestampWithTimeZoneJdbcTypeDescriptor INSTANCE = new TimestampWithTimeZoneJdbcTypeDescriptor();

	public TimestampWithTimeZoneJdbcTypeDescriptor() {
	}
	...
	public <T> BasicJavaTypeDescriptor<T> getJdbcRecommendedJavaTypeMapping(
		...
		return (BasicJavaTypeDescriptor<T>) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( OffsetDateTime.class );
	}
