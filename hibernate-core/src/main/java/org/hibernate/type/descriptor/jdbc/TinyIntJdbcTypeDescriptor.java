 ...
 */
public class TinyIntJdbcTypeDescriptor implements JdbcTypeDescriptor {
	public static final TinyIntJdbcTypeDescriptor INSTANCE = new TinyIntJdbcTypeDescriptor();

	public TinyIntJdbcTypeDescriptor() {
	}
	...
	public <T> BasicJavaTypeDescriptor<T> getJdbcRecommendedJavaTypeMapping(
		...
		return (BasicJavaTypeDescriptor<T>) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( Byte.class );
	}
