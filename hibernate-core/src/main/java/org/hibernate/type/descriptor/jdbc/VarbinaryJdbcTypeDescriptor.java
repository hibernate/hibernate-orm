 ...
 */
public class VarbinaryJdbcTypeDescriptor implements AdjustableJdbcTypeDescriptor {
	public static final VarbinaryJdbcTypeDescriptor INSTANCE = new VarbinaryJdbcTypeDescriptor();
	public static final VarbinaryJdbcTypeDescriptor INSTANCE_WITHOUT_LITERALS = new VarbinaryJdbcTypeDescriptor( false );

	private final boolean supportsLiterals;

	public VarbinaryJdbcTypeDescriptor() {
		this( true );
	}

	public VarbinaryJdbcTypeDescriptor(boolean supportsLiterals) {
	...
	@Override
	public JdbcTypeDescriptor resolveIndicatedType(JdbcTypeDescriptorIndicators indicators, JavaType<?> domainJtd) {
