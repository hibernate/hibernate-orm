 ...
 */
public class VarcharJdbcTypeDescriptor implements AdjustableJdbcTypeDescriptor {
	public static final VarcharJdbcTypeDescriptor INSTANCE = new VarcharJdbcTypeDescriptor();

	public VarcharJdbcTypeDescriptor() {
	}
	...
	public <T> BasicJavaTypeDescriptor<T> getJdbcRecommendedJavaTypeMapping(
		...
		if ( length != null && length == 1 ) {
			return (BasicJavaTypeDescriptor<T>) typeConfiguration.getJavaTypeDescriptorRegistry().getDescriptor( Character.class );
		}
