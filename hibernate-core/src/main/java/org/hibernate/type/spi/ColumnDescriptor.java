...
public class ColumnDescriptor {
	...
	public ColumnDescriptor(SqlTypeDescriptor sqlTypeDescriptor) {
		this( sqlTypeDescriptor, null, null );
	}

	public ColumnDescriptor(SqlTypeDescriptor sqlTypeDescriptor, Size dictatedSize, Size defaultSize) {
