...
public abstract class BaseUserTypeSupport<T> implements UserType<T> {
	private BasicJavaDescriptor<T> javaType;
	...
	protected abstract void resolve(BiConsumer<BasicJavaDescriptor<T>,JdbcTypeDescriptor> resolutionConsumer);
	...
	protected BasicJavaDescriptor<T> javaType() {
		ensureResolved();
		return javaType;
	}
