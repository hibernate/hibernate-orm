...
public class StaticUserTypeSupport<T> implements UserType<T> {
	private final BasicJavaDescriptor javaType;
	...
	public StaticUserTypeSupport(BasicJavaDescriptor javaType, JdbcTypeDescriptor jdbcType) {
		this( javaType, jdbcType, javaType.getMutabilityPlan() );
	}

	public StaticUserTypeSupport(
			BasicJavaDescriptor javaType,
	...
	public StaticUserTypeSupport(BasicJavaDescriptor javaType, JdbcTypeDescriptor jdbcType, MutabilityPlan mutabilityPlan, BasicValueConverter valueConverter) {
	...
	public BasicJavaDescriptor getJavaType() {
		return javaType;
	}
