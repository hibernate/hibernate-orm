 ...
 */
package org.hibernate.envers.test.entitynames.notaudited.onetomany;

import java.util.ArrayList;
import java.util.List;

import org.hibernate.envers.test.EnversSingleSessionBasedFunctionalTest;
import org.hibernate.envers.test.support.domains.entitynames.notaudited.onetomany.Car;
import org.hibernate.envers.test.support.domains.entitynames.notaudited.onetomany.Person;
...
public class ReadEntityWithAuditedCollectionTest extends EnversSingleSessionBasedFunctionalTest {
	...
	protected String[] getMappings() {
		return new String[] { "entityNames/notaudited/onetomany/mappings.hbm.xml" };
	}
	...
	private void assertEntityNames() {
		...
		assertThat( inSession( session -> { return session.getEntityName( currentPerson1 ); } ), equalTo( personName ) );
	}
}
