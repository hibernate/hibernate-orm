...
public class DoubleFlushModDelTest extends EnversEntityManagerFactoryBasedFunctionalTest {
	private Integer id;
	...
	public void testHistoryOfId() {
		...
		assertThat( getAuditReader().find( StrTestEntity.class, id, 2 ), nullValue() );
	}
	...
	public void testRevisionTypes() {
		...
		assertThat( results.get( 1 )[2], equalTo( RevisionType.DEL ) );
	}
}