...
package org.hibernate.envers.test.inheritance.joined.childrelation;
...
public class ChildReferencingTest extends EnversEntityManagerFactoryBasedFunctionalTest {
	...
	public void testHistoryOfReferencedCollection2() {
		...
		assertThat( getAuditReader().find( ReferencedEntity.class, re_id2, 3 ).getReferencing(), contains( child ) );
	}
