...
public class VersionsJoinTableRangeComponentTestEntity {
	...
	// added here as a part of consolidation to hide it from metamodel generator.
	// this class seemed to create test compilation failures if it were a standalone class.
	@Embeddable
	public static class VersionsJoinTableRangeComponent<T extends VersionsJoinTableRangeTestEntitySuperClass> {
