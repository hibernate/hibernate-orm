 ...
 */
public abstract class AbstractPropertiesAudited2Test extends EnversEntityManagerFactoryBasedFunctionalTest {
	private long ai_id;
	private long nai_id;
	...
	public void testRetrieveNonAudited() {
		// levanto las versiones actuales
		final NonAuditedImplementor nai = getEntityManager().find( NonAuditedImplementor.class, nai_id );
		assertThat( nai, notNullValue() );
		final SimpleInterface si = getEntityManager().find( SimpleInterface.class, nai_id );
		assertThat( si, notNullValue() );
