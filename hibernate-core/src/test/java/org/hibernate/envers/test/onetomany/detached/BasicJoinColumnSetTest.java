	...
	public void prepareAuditData() {
		inTransactions(
				...
				entityManager -> {
					...
					final SetJoinColumnRefCollEntity coll1 = new SetJoinColumnRefCollEntity( 3, "coll1" );
				...
				entityManager -> {
					...
					final SetJoinColumnRefCollEntity coll1 = entityManager.find( SetJoinColumnRefCollEntity.class, coll1_id );
