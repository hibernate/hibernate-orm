 ...
 */
public class CustomDateTest extends EnversEntityManagerFactoryBasedFunctionalTest {
	private Integer id;
	...
	public void prepareAuditData() {
		// CustomDateRevEntity.dateTimestamp maps to a DATE data type which on some databases
		// will end up being truncated to seconds, e.g. MySQL 5.1
