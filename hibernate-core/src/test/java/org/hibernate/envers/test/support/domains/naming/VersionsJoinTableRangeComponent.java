...
//	@AuditJoinTable(name = "JOIN_TABLE_COMPONENT_1_AUD", inverseJoinColumns = @JoinColumn(name = "VJTRTE_ID"))
//	private List<T> range = new ArrayList<>();
//
//	// ********************** Accessor Methods ********************** //
//
...
// todo 6.0 - this seems to generate a JPA staticmodel failure, reported by HHH-12030.
//		This should be fixed before this embeddable, its related entities, and test can be enabled.