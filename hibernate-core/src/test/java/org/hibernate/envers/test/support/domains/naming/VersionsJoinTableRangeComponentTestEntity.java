...
public class VersionsJoinTableRangeComponentTestEntity {
	...
	@AuditOverride(
			...
			auditJoinTable = @AuditJoinTable(
					name = "JOIN_TABLE_COMPONENT_1_AUD",
					inverseJoinColumns = @JoinColumn(name = "VJTRTE_ID")
			)
	)
	private VersionsJoinTableRangeComponent<VersionsJoinTableRangeTestEntity> component1 =
			new VersionsJoinTableRangeComponent<>();
	...
	@AuditOverrides(value = {
			@AuditOverride(
					name = "range",
					auditJoinTable = @AuditJoinTable(
							name = "JOIN_TABLE_COMPONENT_2_AUD",
							inverseJoinColumns = @JoinColumn(name = "VJTRTAE_ID") )
			)
	} )
	private VersionsJoinTableRangeComponent<VersionsJoinTableRangeTestAlternateEntity> component2 =
			new VersionsJoinTableRangeComponent<>();
