...
public class CompositeIdAutoTest extends BaseCoreFunctionalTestCase {

	@Test
	public void test() {
		doInHibernate( this::sessionFactory, session -> {
			CompositeIdAutoEntity entity = new CompositeIdAutoEntity();
	...
	protected Class<?>[] getAnnotatedClasses() {
		return new Class<?>[] { CompositeIdAutoEntity.class };
	}
}
