...
public class CompositeIdTableTest extends BaseCoreFunctionalTestCase {

	@Test
	public void test() {
		doInHibernate( this::sessionFactory, session -> {
			CompositeIdTableEntity entity = new CompositeIdTableEntity();
	...
	protected Class<?>[] getAnnotatedClasses() {
		return new Class<?>[] { CompositeIdTableEntity.class };
	}
}
