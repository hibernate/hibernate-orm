 ...
 */
@Jpa(
		annotatedClasses = { LazyCollectionValidationTest.UserWithEnumRoles.class, LazyCollectionValidationTest.UserWithStringRoles.class, LazyCollectionValidationTest.StringUserRole.class, LazyCollectionValidationTest.EnumUserRole.class },
...
public class LazyCollectionValidationTest {
	...
	public void testWithEnumCollection(EntityManagerFactoryScope scope) {
		...
		scope.inTransaction(
				entityManager -> {
					for ( UserWithEnumRoles user : entityManager.createQuery( "Select u from enumuser u", UserWithEnumRoles.class).getResultList()) {
	...
	public void testWithNormalCollection(EntityManagerFactoryScope scope) {
		...
		Set<StringUserRole> bosses = scope.fromTransaction(
				entityManager -> {
		...
		Set<StringUserRole> dorks = scope.fromTransaction(
				entityManager -> {
		...
		scope.inTransaction(
				entityManager -> {
					for ( UserWithStringRoles userWithStringRoles : entityManager.createQuery( "Select u from stringuser u", UserWithStringRoles.class).getResultList()) {
