...
@DomainModel( annotatedClasses = {
		...
		GenericEmbeddedPropertyTest.AccessReport.class,
		GenericEmbeddedPropertyTest.Group.class,
		GenericEmbeddedPropertyTest.User.class,
		GenericEmbeddedPropertyTest.UserReport.class,
		GenericEmbeddedPropertyTest.GroupReport.class,
		GenericEmbeddedPropertyTest.GroupAccessReport.class,
		GenericEmbeddedPropertyTest.UserAccessReport.class
} )
@Jira( "https://hibernate.atlassian.net/browse/HHH-16491" )
public class GenericEmbeddedPropertyTest {
	@BeforeAll
	public void setUp(SessionFactoryScope scope) {
		scope.inTransaction( session -> {
			...
			userAccessReport.setProp( new EmbeddableProp<>( user, new UserReport( "user_report" ), 1 ) );
			session.persist( userAccessReport );
			final Group group = new Group( "group" );
			session.persist( group );
			final GroupAccessReport groupAccessReport = new GroupAccessReport();
			groupAccessReport.setProp( new EmbeddableProp<>( group, new GroupReport( "group_report" ), 2 ) );
