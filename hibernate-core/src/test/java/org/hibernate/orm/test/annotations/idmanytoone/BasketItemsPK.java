...
public class BasketItemsPK implements Serializable {
	...
	public boolean equals(Object aObj) {
		...
		if ( ( getCost() != null && !getCost().equals( basketitemspk.getCost() ) ) || ( getCost() == null && basketitemspk
				.getCost() != null ) ) {
			return false;
		}
		return true;
	...
	public int hashCode() {
		...
		if ( getShoppingBaskets() != null ) {
			hashcode = hashcode + ( getShoppingBaskets().getOwner() == null ?
					0 :
					getShoppingBaskets().getOwner().hashCode() );
			hashcode = hashcode + ( getShoppingBaskets().getBasketDatetime() == null ?
					0 :
