...
@Jpa(
		annotatedClasses = {
				SingleTableInheritanceEagerAssociationTest.Address.class,
				SingleTableInheritanceEagerAssociationTest.AddressA.class,
				SingleTableInheritanceEagerAssociationTest.AddressB.class,
				SingleTableInheritanceEagerAssociationTest.User.class,
				SingleTableInheritanceEagerAssociationTest.UserA.class,
				SingleTableInheritanceEagerAssociationTest.UserB.class,
