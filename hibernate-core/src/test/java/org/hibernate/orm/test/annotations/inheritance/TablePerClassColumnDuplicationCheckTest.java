...
@DomainModel(annotatedClasses = {
		TablePerClassColumnDuplicationCheckTest.Pool.class, TablePerClassColumnDuplicationCheckTest.SwimmingPool.class
})
...
public class TablePerClassColumnDuplicationCheckTest {
	...
	@Entity
	@SecondaryTables({
			@SecondaryTable(name = "POOL_ADDRESS"), @SecondaryTable(name = "POOL_ADDRESS_2")
	})
