...
public class SerializableToBlobTypeTest extends BaseNonConfigCoreFunctionalTestCase {
	...
	public void testTypeDefinition() {
		...
		// The default type for serializable changed to SerializableType which returns the class name
		assertEquals( ExplicitSerializable.class.getName(), explicitLobType.getName() );
