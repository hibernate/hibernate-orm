...
public class LazyAnyDiscriminatorQueryTest {
	...
	public void setUp(EntityManagerFactoryScope scope) {
		scope.inTransaction(
				entityManager -> {
					StringProperty property = new StringProperty( STRING_PROPERTY_ID, STRING_PROPERTY_VALUE );
					PropertyHolder propertyHolder = new PropertyHolder( PROPERTY_HOLDER_ID, property );
	...
	public void testNativeQuery(EntityManagerFactoryScope scope) {
		scope.inTransaction(
				entityManager -> {
					...
					assertFalse( Hibernate.isInitialized( property ) );
