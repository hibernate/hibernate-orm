...
public class SpecifiedMixedStrategyTests {
	@Test
	...
	void verifyDomainModel(SessionFactoryScope sessions) {
		sessions.withSessionFactory( (factory) -> {
			...
			assertThat( cashDiscriminatorValue.getValue() ).isEqualTo( "CASH" );
			...
			final DiscriminatorValueDetails checkDiscriminatorValue = discriminatorConverter.getDetailsForEntityName( AnotherPaymentType.class.getName() );
			assertThat( checkDiscriminatorValue.getValue() ).isEqualTo( AnotherPaymentType.class.getName() );
		} );
	}
