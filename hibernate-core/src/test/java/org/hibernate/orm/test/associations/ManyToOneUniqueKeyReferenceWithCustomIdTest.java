...
public class ManyToOneUniqueKeyReferenceWithCustomIdTest {
    ...
    static class CustomIdType implements EnhancedUserType<CustomId> {
        ...
        @Override
        public void nullSafeSet(PreparedStatement st, CustomId value, int index,
                                SharedSessionContractImplementor session) throws SQLException {
            st.setObject( index, value.toString(), getSqlType() );
        }

        @Override
        public CustomId nullSafeGet(ResultSet rs, int position, SharedSessionContractImplementor session, Object owner) throws SQLException {
