...
@DomainModel(
		annotatedClasses = {
				...
				BatchAndEmbeddedIdId2Test.Parent.class
		}
)
@SessionFactory(
...
public class BatchAndEmbeddedIdId2Test {
	...
	public static class Child {
		...
		public Parent getParent() {
			return id.getNestedEmbeddableId().getParent();
		}
	}

	@Embeddable
	public static class NestedEmbeddableId implements Serializable {
	...
	public static class EmbeddableId implements Serializable {
		...
		private NestedEmbeddableId nestedEmbeddableId;
		...
		public EmbeddableId(Long id, Parent parent) {
			this.id = id;
			this.nestedEmbeddableId = new NestedEmbeddableId(parent);
		}
		...
		public NestedEmbeddableId getNestedEmbeddableId() {
			return nestedEmbeddableId;
		}
	}
	...
	public static class Parent {
		...
		@OneToMany(mappedBy = "id.nestedEmbeddableId.parent", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
