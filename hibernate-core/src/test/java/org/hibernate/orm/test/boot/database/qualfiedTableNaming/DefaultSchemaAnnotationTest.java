...
@DefaultSchema(schema = DefaultSchemaAnnotationTest.DEFAULT_SCHEMA,
		catalog = DefaultSchemaAnnotationTest.DEFAULT_CATALOG)
public class DefaultSchemaAnnotationTest {

	private static final String SQL_QUOTE_CHARACTER_CLASS = "([`\"]|\\[|\\])";

	public static final String EXPLICIT_CATALOG = "someExplicitCatalog";
	public static final String EXPLICIT_SCHEMA = "someExplicitSchema";
	public static final String DEFAULT_CATALOG = "theCatalog";
	public static final String DEFAULT_SCHEMA = "theSchema";
...
//				EntityWithDefaultQualifiersWithCustomSql.class,
		...
		StandardServiceRegistry serviceRegistry = createStandardServiceRegistry();
	...
	private StandardServiceRegistry createStandardServiceRegistry() {
...
//		verifyOnlyQualifier( sql, SqlType.DDL, EntityWithDefaultQualifiersWithCustomSql.NAME, expectedDefaultQualifier() );
	...
	private ExpectedQualifier expectedDefaultQualifier() {
		return expectedQualifier(DEFAULT_CATALOG, DEFAULT_SCHEMA);
	}
...
//	}
	...
	public static class EntityWithDefaultQualifiersWithSequenceGenerator {
		...
		@SequenceGenerator(name = NAME + "_generator", sequenceName = NAME + "_seq",
				schema = DEFAULT_SCHEMA, catalog = DEFAULT_CATALOG)
		private Long id;
		@Basic
		private String basic;
	}
	...
	public static class EntityWithDefaultQualifiersWithIncrementGenerator {
		...
		@GenericGenerator(name = NAME + "_generator", strategy = "increment", parameters = {
				@Parameter(name = "catalog", value = DEFAULT_CATALOG),
