...
public class MappingSourceContributionsTests {
	...
	void adaptsPersistenceUnitDescriptorSources() {
		...
		assertThat( sourceContributions.managedClasses() ).isEmpty();
		assertThat( sourceContributions.managedClassNames() ).containsExactly( MappedEntity.class.getName() );
		assertThat( sourceContributions.packageNames() ).containsExactly( PACKAGE_NAME );
		assertThat( sourceContributions.mappingResources() ).containsExactly(
				"org/hibernate/orm/test/boot/models/source/available.xml"
		);
		assertThat( sourceContributions.includeUnlistedPersistentSuperclasses() ).isFalse();
	}
	...
	void adaptsPersistenceUnitDescriptorJarFileScanning(ServiceRegistryScope registryScope) throws Exception {
		...
		assertThat( sourceContributions.managedClassNames() ).containsExactly( "example.ScannedEntity" );
		assertThat( sourceContributions.packageNames() ).containsExactly( "example.packageinfo" );
		assertThat( sourceContributions.mappingFileUris() )
