...
@ServiceRegistry(
		settingProviders = {
				@SettingProvider(
						...
						provider = GlobalTemporaryTableMutationStrategyCompositeIdTest.QueryMultyTableMutationStrategyProvider.class
				),
				@SettingProvider(
						settingName = AvailableSettings.QUERY_MULTI_TABLE_INSERT_STRATEGY,
						provider = GlobalTemporaryTableMutationStrategyCompositeIdTest.QueryMultyTableInsertStrategyProvider.class
				)
		}
)
public class GlobalTemporaryTableMutationStrategyCompositeIdTest extends AbstractMutationStrategyCompositeIdTest {
