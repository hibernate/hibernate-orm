...
@ServiceRegistry(
		settingProviders = {
				@SettingProvider(
						...
						provider = LocalTemporaryTableMutationStrategyGeneratedIdentityTest.QueryMultyTableInsertStrategyProvider.class
				)
		}
)
public class LocalTemporaryTableMutationStrategyGeneratedIdentityTest
