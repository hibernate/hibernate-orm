...
@ServiceRegistry(
		settingProviders = {
				@SettingProvider(
						...
						provider = LocalTemporaryTableMutationStrategyIdTest.QueryMultyTableMutationStrategyProvider.class
				),
				@SettingProvider(
						settingName = AvailableSettings.QUERY_MULTI_TABLE_INSERT_STRATEGY,
						provider = LocalTemporaryTableMutationStrategyIdTest.QueryMultyTableInsertStrategyProvider.class
				)
		}
)
