...
@ServiceRegistry(
		settingProviders = {
				@SettingProvider(
						...
						provider = PersistentTableMutationStrategyIdTest.QueryMultyTableMutationStrategyProvider.class
				),
				@SettingProvider(
						settingName = AvailableSettings.QUERY_MULTI_TABLE_INSERT_STRATEGY,
						provider = PersistentTableMutationStrategyIdTest.QueryMultyTableInsertStrategyProvider.class
				)
		}
)
public class PersistentTableMutationStrategyIdTest extends AbstractMutationStrategyIdTest {
