...
public class BeanReflectionHelper {
	...
	static {
		...
		PropertyAccess propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someString", true );
		...
		propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someLong", true );
		...
		propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someInteger", true );
		getter = propertyAccess.getGetter();
		setter = propertyAccess.getSetter();
		...
		propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someDate", true );
		getter = propertyAccess.getGetter();
		setter = propertyAccess.getSetter();
		...
		propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someint", true );
		getter = propertyAccess.getGetter();
		setter = propertyAccess.getSetter();
		...
		propertyAccess = propertyAccessStrategy.buildPropertyAccess( TestPropertyAccessorService.INSTANCE, Bean.class, "someObject", true );
		getter = propertyAccess.getGetter();
		setter = propertyAccess.getSetter();
