...
@DomainModel(
		annotatedClasses = {
				ManyToOneWithOptimisticLockingTest.Product.class,
				ManyToOneWithOptimisticLockingTest.Operator.class
		}
)
@ServiceRegistry(
		settings = {
...
@JiraKey("HHH-16673")
public class ManyToOneWithOptimisticLockingTest {
	...
	public void tearDown(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "delete from Operator" ).executeUpdate();
				}
		);
	}
