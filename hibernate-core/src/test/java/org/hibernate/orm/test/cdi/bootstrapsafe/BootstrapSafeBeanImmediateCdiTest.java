 ...
 * {@code getBootstrapSafeBean()} wraps the bean in a {@link DelayedBeanImpl}
...
public class BootstrapSafeBeanImmediateCdiTest {
	...
	@Test
	public void testReturnsDelayedBean() {
		...
		assertThat( bean ).isInstanceOf( DelayedBeanImpl.class );
	}
	...
	public void testUncachedBootstrapSafeBean() {
		final ManagedBean<HostedBean> first = registry.getUncachedBootstrapSafeBean( HostedBean.class );
		final ManagedBean<HostedBean> second = registry.getUncachedBootstrapSafeBean( HostedBean.class );
		assertThat( first ).isNotSameAs( second );
		assertThat( first ).isInstanceOf( DelayedBeanImpl.class );

		final HostedBean instance = first.getBeanInstance();
		assertThat( instance ).isNotNull();
		assertThat( instance.getInjectedHostedBean() ).isNotNull();
	}
}
