...
public class H2DialectSQLPaginationTest {

	@Test
	@TestForIssue(jiraKey = "HHH-17700")
	@SuppressWarnings("rawtypes")
	public void testPaginatedParameterizedNativeQueries(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					for ( String queryName : new String[] {
							...
							"getPersonNames5",
							"getPersonNames6",
							"getPersonNamesForUpdate",
							"getPersonNamesForUpdate2",
							"getPersonNamesForUpdate3",
							"getPersonNamesForUpdate4"
					} ) {
