	...
	public void setUp(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					entityA.setComponentA( componentA );

					ComponentA componentA2 = new ComponentA();
					componentA2.setEntityA( entityA2 );
					entityA2.setComponentA( componentA2 );
		...
		scope.inSession(
				session -> {
					...
					try {
						...
						assertThat( entityA1.getId() ).isEqualTo( 1 );
						assertThat( entityA1.getComponentA() ).isNotNull();
						assertThat( entityA1.getComponentB() ).isNotNull();
						assertThat( entityA1.getComponentB().getEntityD() ).isNotNull();
	...
	public void testQueryEntityB(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat( entityA.getComponentA() ).isNotNull();
