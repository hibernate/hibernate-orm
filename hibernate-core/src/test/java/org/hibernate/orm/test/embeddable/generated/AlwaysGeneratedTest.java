...
@DomainModel(
		annotatedClasses = {
				AlwaysGeneratedTest.TestEntity.class
		}
)
@SessionFactory(
		exportSchema = false,
...
@Jira("HHH-16957")
public class AlwaysGeneratedTest {
	...
	private static void assertThatInsertIsCorrect(String insertQuery) {
		...
		assertThat( insertQuery ).contains( ALWAYS_GENERATED_PROP_WRITABLE_0_COLUMN );
		assertThat( insertQuery ).contains( NON_GENERATED_PROP_1_COLUMN );
		assertThat( insertQuery ).contains( ALWAYS_GENERATED_PROP_WRITABLE_1_COLUMN );
...
//		assertThat( selectQuery ).doesNotContain( NON_GENERATED_PROP_1_COLUMN );
	...
	private static void assertThatUpdateStatementIsCorrect(String updateQuery) {
		...
		assertThat( updateQuery ).contains( ALWAYS_GENERATED_PROP_WRITABLE_0_COLUMN );
		assertThat( updateQuery ).contains( NON_GENERATED_PROP_1_COLUMN );
		assertThat( updateQuery ).contains( ALWAYS_GENERATED_PROP_WRITABLE_1_COLUMN );
