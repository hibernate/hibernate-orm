...
public class GraphParsingTest extends AbstractEntityGraphTest {
	...
	@Test
	public void testParsingExample1(EntityManagerFactoryScope scope) {
	...
	@Test
	public void testParsingExample2(EntityManagerFactoryScope scope) {
		scope.inEntityManager(
				entityManager -> {
	...
	@Test
	public void testEntityKeyParsing(EntityManagerFactoryScope scope) {
		scope.inEntityManager(
				entityManager -> {
	...
	@Test
	public void testMergingExample(EntityManagerFactoryScope scope) {
		scope.inEntityManager(
				entityManager -> {
					...
					assertThat( EntityGraphs.areEqual( expected, all ) ).isTrue();
				}
		);
	}

	@Test
	public void testFindExample(EntityManagerFactoryScope scope) {
	...
	@Test
	public void testQueryExample(EntityManagerFactoryScope scope) {
		scope.inTransaction( entityManager -> {
