 ...
 */
@DomainModel(annotatedClasses = ArrayToStringWithArrayAggregateTest.Book.class)
@SessionFactory
...
public class ArrayToStringWithArrayAggregateTest {
	...
	@Test
	@FailureExpected(jiraKey = "HHH-18981", reason = "throws an ArrayIndexOutOfBoundsException")
