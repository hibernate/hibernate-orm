...
public class AutoGenerationTypeTests {
	...
	public void testAutoDefaults() {
		try (final StandardServiceRegistry ssr = ServiceRegistryUtil.serviceRegistry()) {
			final Metadata metadata = MetadataBuildingTestHelper.buildMetadata( ssr, Entity1.class, Entity2.class );
	...
	public void testUuid() {
		try (final StandardServiceRegistry ssr = ServiceRegistryUtil.serviceRegistry()) {
			final Metadata metadata = MetadataBuildingTestHelper.buildMetadata( ssr, Entity4.class );
	...
	public void testIncrement() {
		try (final StandardServiceRegistry ssr = ServiceRegistryUtil.serviceRegistry()) {
			final Metadata metadata = MetadataBuildingTestHelper.buildMetadata( ssr, Entity3.class );
