...
@Jpa(
		annotatedClasses = {
				CriteriaMutationQueryWithSecondaryTableTest.Animal.class,
				CriteriaMutationQueryWithSecondaryTableTest.Person.class
		}
		,
		properties = {
...
public class CriteriaMutationQueryWithSecondaryTableTest {
	...
	@Entity(name = "Animal")
	@SecondaryTables({
			@SecondaryTable(name = "ANIMAL_DETAILS", pkJoinColumns = @PrimaryKeyJoinColumn(name = "ID"))
	})
	...
	public static class Animal {
		...
		@Column(name = "DETAILS", table = "ANIMAL_DETAILS")
