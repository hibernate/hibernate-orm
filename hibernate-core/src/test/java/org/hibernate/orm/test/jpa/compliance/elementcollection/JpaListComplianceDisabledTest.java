...
@Jpa(
		annotatedClasses = { JpaListComplianceDisabledTest.Person.class}
)
public class JpaListComplianceDisabledTest {
	...
	public void testIt(EntityManagerFactoryScope scope) {
		...
		scope.inTransaction(
				entityManager -> {
					...
					assertInstanceOf( PersistentList.class,  p.getAddresses());
				}
		);
	}
