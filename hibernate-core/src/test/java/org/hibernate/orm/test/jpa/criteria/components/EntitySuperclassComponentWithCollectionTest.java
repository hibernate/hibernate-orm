...
@Jpa(annotatedClasses = {
		...
		EntitySuperclassComponentWithCollectionTest.Project.class,
		EntitySuperclassComponentWithCollectionTest.Person.class,
		EntitySuperclassComponentWithCollectionTest.Leader.class
})
public class EntitySuperclassComponentWithCollectionTest {
