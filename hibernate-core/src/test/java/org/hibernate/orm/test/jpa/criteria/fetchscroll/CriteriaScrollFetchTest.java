...
public class CriteriaScrollFetchTest {
	...
	@Test
	@Jira("https://hibernate.atlassian.net/browse/HHH-17497")
	// TODO remove both annotations below after fixing the issue!
	@FailureExpected
	@SkipForDialect( dialectClass = MariaDBDialect.class, reason = "Exluding MariaDB since this test doesn't fail on it, " +
			"which makes FailureExpected fail the CI test run" )
