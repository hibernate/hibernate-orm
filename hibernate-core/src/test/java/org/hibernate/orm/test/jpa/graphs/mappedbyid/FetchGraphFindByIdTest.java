...
public class FetchGraphFindByIdTest {
	...
	public void testFetchGraphByFind(EntityManagerFactoryScope scope) {
		...
		EntityGraph<Company> entityGraph = scope.fromTransaction(
				entityManager -> {
	...
	public void testFetchGraphByFindTakingPrecedenceOverFetchProfile(EntityManagerFactoryScope scope) {
		...
		EntityGraph<CompanyFetchProfile> entityGraph = scope.fromTransaction(
				entityManager -> {
	...
	public void tearDown(EntityManagerFactoryScope scope) {
		scope.inTransaction(
				entityManager -> {
					...
					entityManager.createQuery( "delete from CompanyFetchProfile" ).executeUpdate();
