...
@Jpa(
		annotatedClasses = {
				CachedQueryShallowWithCollectionTest.Manager.class,
				CachedQueryShallowWithCollectionTest.Employee.class
		},
...
public class CachedQueryShallowWithCollectionTest {

	public final static String HQL = "select e from Manager e left join fetch e.associates";
