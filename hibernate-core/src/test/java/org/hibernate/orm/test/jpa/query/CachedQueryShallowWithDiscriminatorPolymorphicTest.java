...
@Jpa(
		annotatedClasses = {
				CachedQueryShallowWithDiscriminatorPolymorphicTest.Person.class,
				CachedQueryShallowWithDiscriminatorPolymorphicTest.Employee.class
		},
...
public class CachedQueryShallowWithDiscriminatorPolymorphicTest {
	...
	@QueryCacheLayout(layout = CacheLayout.SHALLOW_WITH_DISCRIMINATOR)
