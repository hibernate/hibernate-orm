...
public class TheEntityXml {
	...
	public TheEntityXml(Integer id, String userCode, String assignment, String name, TheComponent theComponent, Set<TheComponent> theComponents) {
		this.id = id;
