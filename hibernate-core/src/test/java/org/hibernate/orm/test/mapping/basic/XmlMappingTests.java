...
public abstract class XmlMappingTests {
	...
	public static class Jackson extends XmlMappingTests {
		...
		@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "CUBRID stores XML as a CLOB, and the driver's getString() leaves wasNull set from the preceding null column, so the value after it is discarded")
