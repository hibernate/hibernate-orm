...
class JoinFormulaCompositeUnidiTest {
	...
	@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "hibernate-core renders a @JoinFormula through Template without quoting, and DEPTH is a CUBRID reserved word")
