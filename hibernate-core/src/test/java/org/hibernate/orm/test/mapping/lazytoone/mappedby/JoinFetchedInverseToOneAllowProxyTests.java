...
@DomainModel(
		annotatedClasses = {
				JoinFetchedInverseToOneAllowProxyTests.Customer.class, JoinFetchedInverseToOneAllowProxyTests.SupplementalInfo.class
		}
)
@SessionFactory
@BytecodeEnhanced
@EnhancementOptions( lazyLoading = true )
public class JoinFetchedInverseToOneAllowProxyTests {
