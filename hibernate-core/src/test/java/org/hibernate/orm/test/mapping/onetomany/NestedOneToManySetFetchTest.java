...
@DomainModel( annotatedClasses = {
		NestedOneToManySetFetchTest.Role.class,
		NestedOneToManySetFetchTest.Permission.class,
		NestedOneToManySetFetchTest.Operation.class
} )
@Jira( "https://hibernate.atlassian.net/browse/HHH-16496" )
public class NestedOneToManySetFetchTest {
	@BeforeAll
