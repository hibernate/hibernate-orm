...
@DomainModel(annotatedClasses = {
		ReloadInconsistentReadOnlyDelayedFetchTest.EntityA.class,
		ReloadInconsistentReadOnlyDelayedFetchTest.EntityB.class
})
@SessionFactory
@Jira("https://hibernate.atlassian.net/browse/HHH-19273")
public class ReloadInconsistentReadOnlyDelayedFetchTest {
