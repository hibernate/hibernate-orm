...
@DomainModel(annotatedClasses = {
		ReloadInconsistentReadOnlyEagerAnyFetchTest.EntityA.class,
		ReloadInconsistentReadOnlyEagerAnyFetchTest.EntityB.class
})
@SessionFactory
@Jira("https://hibernate.atlassian.net/browse/HHH-19273")
public class ReloadInconsistentReadOnlyEagerAnyFetchTest {
