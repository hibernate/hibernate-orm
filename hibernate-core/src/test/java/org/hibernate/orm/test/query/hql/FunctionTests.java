...
public class FunctionTests {
	...
	public void prepareData(SessionFactoryScope scope) {
		scope.inTransaction(
				em -> {
					...
					entity.setTheDuration(
							Duration.of( 3, ChronoUnit.SECONDS ).plus( Duration.of( 23, ChronoUnit.MILLIS ) ) );
	...
	public void testImplicitCollectionJoinInSelect(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select index(eol.listOfNumbers) from EntityOfLists eol",
									Integer.class )
							.getResultList(), hasItems( 0, 1 ) );
					assertThat( session.createQuery( "select element(eol.listOfNumbers) from EntityOfLists eol",
									Double.class )
							.getResultList(), hasItems( 1.0, 2.0 ) );

					assertThat(
							session.createQuery( "select key(eom.numberByNumber) from EntityOfMaps eom", Integer.class )
									.getResultList(), hasItems( 1 ) );
					assertThat( session.createQuery( "select value(eom.numberByNumber) from EntityOfMaps eom",
									Double.class )
							.getResultList(), hasItems( 1.0 ) );

					assertThat(
							session.createQuery( "select key(eom.basicByBasic) from EntityOfMaps eom", String.class )
									.getResultList(), hasItems( "hello" ) );
					assertThat(
							session.createQuery( "select value(eom.basicByBasic) from EntityOfMaps eom", String.class )
									.getResultList(), hasItems( "world" ) );

					assertThat( session.createQuery( "select element(eol.listOfOneToMany) from EntityOfLists eol",
							SimpleEntity.class ).getSingleResult().getId(), is( 3 ) );
					assertThat( session.createQuery( "select element(eol.listOfManyToMany) from EntityOfLists eol",
							SimpleEntity.class ).getSingleResult().getId(), is( 6 ) );

					assertThat( session.createQuery(
									"select element(se).someLong from EntityOfLists eol join eol.listOfOneToMany se",
									Long.class )
							.getSingleResult(), is( 5L ) );
					assertThat(
							session.createQuery( "select element(eol.listOfOneToMany).someLong from EntityOfLists eol",
											Long.class )
									.getSingleResult(), is( 5L ) );

					assertThat( session.createQuery(
									"select element(se).someLong from EntityOfLists eol join eol.listOfManyToMany se",
									Long.class )
							.getSingleResult(), is( 10L ) );
					assertThat(
							session.createQuery( "select element(eol.listOfManyToMany).someLong from EntityOfLists eol",
											Long.class )
									.getSingleResult(), is( 10L ) );
				}
		);
	...
	public void testImplicitCollectionJoinInWhere(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					session.createQuery(
									"from EntityOfLists eol join eol.listOfOneToMany se where element(se).someLong=5",
									EntityOfLists.class )
							.getSingleResult();
					session.createQuery( "from EntityOfLists eol where element(eol.listOfOneToMany).someLong=5",
							...
							.getSingleResult();
					session.createQuery(
									"from EntityOfLists eol join eol.listOfManyToMany se where element(se).someLong=10",
									EntityOfLists.class )
							.getSingleResult();
	...
	public void testImplicitCollectionJoinInSelectAggregate(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery(
									"select max(index(eol.listOfNumbers)) from EntityOfLists eol group by eol", Integer.class )
							.getSingleResult(), is( 1 ) );
					assertThat( session.createQuery(
									"select max(element(eol.listOfNumbers)) from EntityOfLists eol group by eol", Double.class )
							.getSingleResult(), is( 2.0 ) );

					assertThat( session.createQuery(
									"select sum(index(eol.listOfNumbers)) from EntityOfLists eol group by eol", Long.class )
							.getSingleResult(), is( 1L ) );
					assertThat( session.createQuery(
									"select sum(element(eol.listOfNumbers)) from EntityOfLists eol group by eol", Double.class )
							.getSingleResult(), is( 3.0 ) );

					assertThat( session.createQuery(
									"select avg(index(eol.listOfNumbers)) from EntityOfLists eol group by eol", Double.class )
							.getSingleResult(), is( 0.5 ) );
					assertThat( session.createQuery(
									"select avg(element(eol.listOfNumbers)) from EntityOfLists eol group by eol", Double.class )
							.getSingleResult(), is( 1.5 ) );

					assertThat( session.createQuery(
									"select max(key(eom.numberByNumber)) from EntityOfMaps eom group by eom", Integer.class )
							.getSingleResult(), is( 1 ) );
					assertThat( session.createQuery(
									"select max(value(eom.numberByNumber)) from EntityOfMaps eom group by eom", Double.class )
							.getSingleResult(), is( 1.0 ) );

					assertThat( session.createQuery(
									"select sum(key(eom.numberByNumber)) from EntityOfMaps eom group by eom", Long.class )
							.getSingleResult(), is( 1L ) );
					assertThat( session.createQuery(
									"select sum(value(eom.numberByNumber)) from EntityOfMaps eom group by eom", Double.class )
							.getSingleResult(), is( 1.0 ) );

					assertThat( session.createQuery(
									"select avg(key(eom.numberByNumber)) from EntityOfMaps eom group by eom", Double.class )
							.getSingleResult(), is( 1.0 ) );
					assertThat( session.createQuery(
									"select avg(value(eom.numberByNumber)) from EntityOfMaps eom group by eom", Double.class )
							.getSingleResult(), is( 1.0 ) );
				}
		);
	}
	...
	public void testAggregateIndexElementWithPath(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat( session.createQuery( "select max(key(eom.numberByNumber)) from EntityOfMaps eom",
									Integer.class )
							.getSingleResult(), is( 1 ) );
					...
					assertThat( session.createQuery( "select sum(key(eom.numberByNumber)) from EntityOfMaps eom",
									Long.class )
							.getSingleResult(), is( 1L ) );
					...
					assertThat( session.createQuery( "select avg(key(eom.numberByNumber)) from EntityOfMaps eom",
									Double.class )
							.getSingleResult(), is( 1.0 ) );
	...
	public void testAggregateIndexElementKeyValueWithAlias(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery(
									"select max(index(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Integer.class )
							.getSingleResult(), is( 1 ) );
					assertThat( session.createQuery(
									"select max(element(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Double.class )
							.getSingleResult(), is( 2.0 ) );

					assertThat( session.createQuery(
									"select sum(index(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Long.class )
							.getSingleResult(), is( 1L ) );
					assertThat( session.createQuery(
									"select sum(element(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Double.class )
							.getSingleResult(), is( 3.0 ) );

					assertThat( session.createQuery(
									"select avg(index(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Double.class )
							.getSingleResult(), is( 0.5 ) );
					assertThat( session.createQuery(
									"select avg(element(l)) from EntityOfLists eol join eol.listOfNumbers l group by eol",
									Double.class )
							.getSingleResult(), is( 1.5 ) );

					assertThat( session.createQuery(
									"select max(key(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Integer.class )
							.getSingleResult(), is( 1 ) );
					assertThat( session.createQuery(
									"select max(value(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Double.class )
							.getSingleResult(), is( 1.0 ) );

					assertThat( session.createQuery(
									"select sum(key(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Long.class )
							.getSingleResult(), is( 1L ) );
					assertThat( session.createQuery(
									"select sum(value(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Double.class )
							.getSingleResult(), is( 1.0 ) );

					assertThat( session.createQuery(
									"select avg(key(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Double.class )
							.getSingleResult(), is( 1.0 ) );
					assertThat( session.createQuery(
									"select avg(value(m)) from EntityOfMaps eom join eom.numberByNumber m group by eom",
									Double.class )
							.getSingleResult(), is( 1.0 ) );
				}
		);
	...
	public void testAsciiChrFunctions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat( session.createQuery( "select ascii('A')", Integer.class ).getSingleResult(),
							anyOf( is( 65 ), is( (short) 65 ) ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select 'foo' || e.theString || 'bar' from EntityOfBasics e", String.class )
							.list();
					assertThat(
							session.createQuery( "select concat('hello',' ','world')", String.class ).getSingleResult(),
							is( "hello world" ) );
					assertThat( session.createQuery( "select 'hello'||' '||'world'", String.class ).getSingleResult(),
							is( "hello world" ) );
				}
		);
	}
	...
	public void testConcatFunctionParameters(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat(
							session.createQuery( "select cast(:hello as String)||cast(:world as String)", String.class )
									.setParameter( "hello", "hello" ).setParameter( "world", "world" )
									.getSingleResult(), is( "helloworld" ) );
					assertThat( session.createQuery( "select cast(?1 as String)||cast(?2 as String)", String.class )
									.setParameter( 1, "hello" ).setParameter( 2, "world" ).getSingleResult(),
							is( "helloworld" ) );
					assertThat( session.createQuery( "select cast(?1 as String)||cast(?1 as String)", String.class )
							.setParameter( 1, "hello" ).getSingleResult(), is( "hellohello" ) );
				}
		);
	}
...
//							.list();
					...
					session.createQuery( "select coalesce(nullif(e.gender,?1), e.gender) from EntityOfBasics e",
							...
							.list();
					session.createQuery(
									"select ifnull(e.gender, org.hibernate.testing.orm.domain.gambit.EntityOfBasics$Gender.FEMALE) from EntityOfBasics e",
									EntityOfBasics.Gender.class )
							.list();
					assertThat(
							session.createQuery( "select coalesce(nullif('',''), nullif('bye','bye'), 'hello', 'oops')",
									String.class ).getSingleResult(), is( "hello" ) );
					assertThat( session.createQuery( "select ifnull(nullif('bye','bye'), 'hello')", String.class )
							.getSingleResult(), is( "hello" ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					session.createQuery( "select nullif(e.theString, '') from EntityOfBasics e", String.class )
							.list();
					assertThat( session.createQuery( "select nullif('foo', 'foo')", String.class ).getSingleResult(),
							nullValue() );
					assertThat( session.createQuery( "select nullif('foo', 'bar')", String.class ).getSingleResult(),
							is( "foo" ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery(
							...
							.list();
					session.createQuery(
									"select exp(e.theDouble), ln(e.theDouble + 1), log10(e.theDouble + 2) from EntityOfBasics e",
									Object[].class )
							.list();
					...
					assertThat( session.createQuery( "select round(32.12345f,2)", Float.class ).getSingleResult(),
							is( 32.12f ) );
	...
	public void testRoundTruncFunctions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select trunc(32.92345f)", Float.class ).getSingleResult(),
							is( 32f ) );
					assertThat( session.createQuery( "select trunc(32.92345f,3)", Float.class ).getSingleResult(),
							is( 32.923f ) );
					assertThat( session.createQuery( "select trunc(-32.92345f)", Float.class ).getSingleResult(),
							is( -32f ) );
					assertThat( session.createQuery( "select trunc(-32.92345f,3)", Float.class ).getSingleResult(),
							is( -32.923f ) );
					assertThat( session.createQuery( "select truncate(32.92345f)", Float.class ).getSingleResult(),
							is( 32f ) );
					assertThat( session.createQuery( "select truncate(32.92345f,3)", Float.class ).getSingleResult(),
							is( 32.923f ) );
					assertThat( session.createQuery( "select round(32.92345f)", Float.class ).getSingleResult(),
							is( 33f ) );
					assertThat( session.createQuery( "select round(32.92345f,1)", Float.class ).getSingleResult(),
							is( 32.9f ) );
					assertThat( session.createQuery( "select round(32.92345f,3)", Float.class ).getSingleResult(),
							is( 32.923f ) );
					assertThat( session.createQuery( "select round(32.923451f,4)", Float.class ).getSingleResult(),
							is( 32.9235f ) );

					assertThat( session.createQuery( "select trunc(32.92345d)", Double.class ).getSingleResult(),
							is( 32d ) );
					assertThat( session.createQuery( "select trunc(32.92345d,3)", Double.class ).getSingleResult(),
							is( 32.923d ) );
					assertThat( session.createQuery( "select trunc(-32.92345d)", Double.class ).getSingleResult(),
							is( -32d ) );
					assertThat( session.createQuery( "select trunc(-32.92345d,3)", Double.class ).getSingleResult(),
							is( -32.923d ) );
					assertThat( session.createQuery( "select truncate(32.92345d)", Double.class ).getSingleResult(),
							is( 32d ) );
					assertThat( session.createQuery( "select truncate(32.92345d,3)", Double.class ).getSingleResult(),
							is( 32.923d ) );
					assertThat( session.createQuery( "select round(32.92345d)", Double.class ).getSingleResult(),
							is( 33d ) );
					assertThat( session.createQuery( "select round(32.92345d,1)", Double.class ).getSingleResult(),
							is( 32.9d ) );
					assertThat( session.createQuery( "select round(32.92345d,3)", Double.class ).getSingleResult(),
							is( 32.923d ) );
					assertThat( session.createQuery( "select round(32.923451d,4)", Double.class ).getSingleResult(),
							is( 32.9235d ) );
				}
		);
	}
	...
	@SkipForDialect(dialectClass = InformixDialect.class,
			reason = "Informix doesn't support any form of date truncation")
	public void testDateTruncFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select truncate(current_timestamp,minute)", Timestamp.class )
							.getSingleResult();
					session.createQuery( "select truncate(current_timestamp,second)", Timestamp.class )
							.getSingleResult();
	...
	@SkipForDialect(dialectClass = OracleDialect.class,
			reason = "See HHH-16442, Oracle trunc() throws away the timezone")
	@SkipForDialect(dialectClass = InformixDialect.class,
			reason = "Informix doesn't support any form of date truncation")
	public void testDateTruncWithOffsetFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select truncate(offset datetime 1974-10-03 12:30-12:00, day)",
					...
					assertThat( session.createQuery( "select truncate(offset datetime 1974-10-03 12:30-12:00, minute)",
									OffsetDateTime.class ).getSingleResult(),
		...
		scope.inTransaction(
				session -> {
					session.createQuery( "select lower(e.theString), upper(e.theString) from EntityOfBasics e",
									Object[].class )
							.list();
					assertThat( session.createQuery( "select lower('HELLO')", String.class ).getSingleResult(),
							is( "hello" ) );
					assertThat( session.createQuery( "select upper('hello')", String.class ).getSingleResult(),
							is( "HELLO" ) );
				}
		);
		...
		scope.inTransaction(
				session -> {
					session.createQuery(
									...
									Integer.class )
							.list();
					assertThat( session.createQuery( "select length('hello')", Integer.class ).getSingleResult(),
							is( 5 ) );
				}
		);
		...
		scope.inTransaction(
				session -> {
					session.createQuery( "select substring(e.theString, e.theInt) from EntityOfBasics e", String.class )
							.list();
					session.createQuery( "select substring(e.theString, 1, e.theInt) from EntityOfBasics e",
									String.class )
							.list();
					session.createQuery( "select substring(e.theString from e.theInt) from EntityOfBasics e",
									String.class )
							.list();
					session.createQuery( "select substring(e.theString from 1 for e.theInt) from EntityOfBasics e",
									String.class )
							.list();
					assertThat( session.createQuery( "select substring('hello world',4, 5)", String.class )
							.getSingleResult(), is( "lo wo" ) );
					assertThat( session.createQuery( "select substring('hello world' from 1 for 5)", String.class )
							.getSingleResult(), is( "hello" ) );
				}
		);
	...
	public void testLeftRightFunctions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					session.createQuery(
									"select left(e.theString, e.theInt), right(e.theString, e.theInt) from EntityOfBasics e",
									Object[].class )
							.list();
					assertThat( session.createQuery( "select left('hello world', 5)", String.class ).getSingleResult(),
							is( "hello" ) );
					assertThat( session.createQuery( "select right('hello world', 5)", String.class ).getSingleResult(),
							is( "world" ) );

					assertThat( session.createQuery( "select right(:data, 5)", String.class )
							.setParameter( "data", "hello world" ).getSingleResult(), is( "world" ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					session.createQuery( "select position('hello' in e.theString) from EntityOfBasics e",
									Integer.class )
							.list();
					assertThat( session.createQuery( "select position('world' in 'hello world')", Integer.class )
							.getSingleResult(), is( 7 ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select locate('hello', e.theString, e.theInteger) from EntityOfBasics e",
									Integer.class )
							.list();
					assertThat( session.createQuery( "select locate('world', 'hello world')", Integer.class )
							.getSingleResult(), is( 7 ) );
				}
		);
	}
	...
	public void testOverlayFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery(
									"select overlay('hello world' placing 'goodbye' from 1 for 5) from EntityOfBasics",
									String.class )
							.list().get( 0 ), is( "goodbye world" ) );
					assertThat( session.createQuery(
									"select overlay('hello world' placing 'goodbye' from 7 for 5) from EntityOfBasics",
									String.class )
					...
					assertThat( session.createQuery(
									"select overlay('xxxxxx' placing ' yy ' from 3 for 2) from EntityOfBasics", String.class )
...
//							is("hellohellohello") );
	...
	public void testReplaceFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					session.createQuery( "select replace(e.theString, 'hello', 'goodbye') from EntityOfBasics e",
									String.class )
							.list();
					assertThat( session.createQuery( "select replace('hello world', 'hello', 'goodbye')", String.class )
									.getSingleResult(),
							is( "goodbye world" ) );
					assertThat( session.createQuery( "select replace('hello world', 'o', 'ooo')", String.class )
									.getSingleResult(),
							is( "hellooo wooorld" ) );
				}
		);
		...
		try {
			scope.inTransaction(
					session -> session.createQuery( "select replace(e.theString, 1, 'goodbye') from EntityOfBasics e",
							String.class ).list()
			);
			fail();
		}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select trim(both ' ' from e.theString) from EntityOfBasics e", String.class )
							.list();
					assertThat( session.createQuery( "select trim(leading from '   hello')", String.class )
							.getSingleResult(), is( "hello" ) );
					assertThat( session.createQuery( "select trim(trailing from 'hello   ')", String.class )
							.getSingleResult(), is( "hello" ) );
					assertThat( session.createQuery( "select trim(both from '   hello   ')", String.class )
							.getSingleResult(), is( "hello" ) );
					assertThat( session.createQuery( "select trim(both '-' from '---hello---')", String.class )
							.getSingleResult(), is( "hello" ) );
				}
	...
	public void testTrimFunctionParameters(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery( "select trim(:param from '---  hello it''s me -- ')", String.class )
									.setParameter( "param", '-' )
									.getSingleResult(), is( "  hello it's me -- " ) );
					assertThat(
							session.createQuery( "select trim(leading ?1 from '  hello it''s me   ')", String.class )
									.setParameter( 1, ' ' )
									.getSingleResult(), is( "hello it's me   " ) );
					assertThat(
							session.createQuery( "select trim(trailing ?1 from '  hello it''s me   ')", String.class )
									.setParameter( 1, ' ' )
									.getSingleResult(), is( "  hello it's me" ) );
	...
	public void testPadFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select pad('hello' with 10 leading)", String.class )
									.getSingleResult(),
							is( "     hello" ) );
					assertThat( session.createQuery( "select pad('hello' with 10 trailing)", String.class )
									.getSingleResult(),
							is( "hello     " ) );
					assertThat( session.createQuery( "select pad('hello' with 10 leading '.')", String.class )
									.getSingleResult(),
	...
	public void testCastFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( (session.createQuery( "select cast(e.theBoolean as String) from EntityOfBasics e",
							String.class ).getSingleResult()).toLowerCase(), is( "false" ) );
					assertThat(
							(session.createQuery( "select cast(e.theNumericBoolean as String) from EntityOfBasics e",
									String.class ).getSingleResult()).toLowerCase(), is( "false" ) );
					assertThat( (session.createQuery( "select cast(e.theStringBoolean as String) from EntityOfBasics e",
							String.class ).getSingleResult()).toLowerCase(), is( "false" ) );
					...
					session.createQuery(
							...
							.list();
					session.createQuery(
									"select cast(e.id as Float), cast(e.theInt as Double), cast(e.theDouble as Long) from EntityOfBasics e",
									Object[].class )
							.list();
					session.createQuery(
									"select cast(e.id as BigInteger(10)), cast(e.theDouble as BigDecimal(10,5)) from EntityOfBasics e",
									Object[].class )
							.list();

					session.createQuery(
									"select cast('1002342345234523.452435245245243' as BigDecimal) from EntityOfBasics",
									BigDecimal.class )
							.list();
					session.createQuery(
									"select cast('1002342345234523.452435245245243' as BigDecimal(30, 10)) from EntityOfBasics",
									BigDecimal.class )
							.list();
					session.createQuery(
									"select cast('1234234523452345243524524524' as BigInteger) from EntityOfBasics",
									BigInteger.class )
							.list();
					session.createQuery(
									"select cast('1234234523452345243524524524' as BigInteger(30)) from EntityOfBasics",
									BigInteger.class )
							.list();
					...
					assertThat( session.createQuery( "select cast(1 as Boolean)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast(0 as Boolean)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat(
							session.createQuery( "select cast('1234' as Integer)", Integer.class ).getSingleResult(),
							is( 1234 ) );
					assertThat( session.createQuery( "select cast('1234' as Short)", Short.class ).getSingleResult(),
							is( (short) 1234 ) );
					assertThat( session.createQuery( "select cast('123' as Byte)", Byte.class ).getSingleResult(),
							is( (byte) 123 ) );
					assertThat( session.createQuery( "select cast('123' as Long)", Long.class ).getSingleResult(),
							is( 123L ) );
					assertThat( session.createQuery( "select cast('123.12' as Float)", Float.class ).getSingleResult(),
							is( 123.12f ) );

					assertThat( session.createQuery( "select cast('hello' as String)", String.class ).getSingleResult(),
							is( "hello" ) );
					assertThat( (session.createQuery( "select cast(true as String)", String.class )
							.getSingleResult()).toLowerCase(), is( "true" ) );
					assertThat( (session.createQuery( "select cast(false as String)", String.class )
							.getSingleResult()).toLowerCase(), is( "false" ) );
					assertThat( session.createQuery( "select cast(123 as String)", String.class ).getSingleResult(),
							is( "123" ) );

					assertThat( session.createQuery( "select cast('1911-10-09' as LocalDate)", LocalDate.class )
							.getSingleResult(), is( LocalDate.of( 1911, 10, 9 ) ) );
					assertThat( session.createQuery( "select cast('12:13:14' as LocalTime)", LocalTime.class )
							.getSingleResult(), is( LocalTime.of( 12, 13, 14 ) ) );
					assertThat( session.createQuery( "select cast('1911-10-09 12:13:14' as LocalDateTime)",
									LocalDateTime.class ).getSingleResult(),
							is( LocalDateTime.of( 1911, 10, 9, 12, 13, 14 ) ) );

					assertThat( session.createQuery( "select cast(local datetime as LocalTime)", LocalTime.class )
							.getSingleResult(), instanceOf( LocalTime.class ) );
					assertThat( session.createQuery( "select cast(local datetime as LocalDate)", LocalDate.class )
							.getSingleResult(), instanceOf( LocalDate.class ) );
					assertThat( session.createQuery( "select cast('1911-10-09 12:13:14.123' as LocalDateTime)",
							LocalDateTime.class ).getSingleResult(), instanceOf( LocalDateTime.class ) );

					assertThat( session.createQuery( "select cast('12:13:14' as Time)", Time.class ).getSingleResult(),
							instanceOf( Time.class ) );
					assertThat(
							session.createQuery( "select cast('1911-10-09' as Date)", Date.class ).getSingleResult(),
							instanceOf( Date.class ) );
					assertThat( session.createQuery( "select cast('1911-10-09 12:13:14.123' as Timestamp)",
							Timestamp.class ).getSingleResult(), instanceOf( Timestamp.class ) );

					if ( !(session.getJdbcServices().getDialect() instanceof GaussDBDialect) ) {
						assertThat( session.createQuery( "select cast(date 1911-10-09 as String)", String.class )
								.getSingleResult(), is( "1911-10-09" ) );
					}
					assertThat( session.createQuery( "select cast(time 12:13:14 as String)", String.class )
							.getSingleResult(), anyOf( is( "12:13:14" ), is( "12:13:14.0000" ), is( "12.13.14" ) ) );
					assertThat(
							session.createQuery( "select cast(datetime 1911-10-09 12:13:14 as String)", String.class )
									.getSingleResult(),
							anyOf( startsWith( "1911-10-09 12:13:14" ), startsWith( "1911-10-09-12.13.14" ) ) );

					assertThat( session.createQuery( "select cast(local datetime as Instant)", Instant.class )
							.getSingleResult(), instanceOf( Instant.class ) );
					assertThat( session.createQuery( "select cast(offset datetime as Instant)", Instant.class )
							.getSingleResult(), instanceOf( Instant.class ) );

					assertThat(
							session.createQuery( "select cast(1 as NumericBoolean)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat(
							session.createQuery( "select cast(0 as NumericBoolean)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat( session.createQuery( "select cast(true as YesNo)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast(false as YesNo)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat( session.createQuery( "select cast(1 as YesNo)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast(0 as YesNo)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat(
							session.createQuery( "select cast(true as TrueFalse)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat(
							session.createQuery( "select cast(false as TrueFalse)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat( session.createQuery( "select cast(1 as TrueFalse)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast(0 as TrueFalse)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat( session.createQuery( "select cast('Y' as YesNo)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast('N' as YesNo)", Boolean.class ).getSingleResult(),
							is( false ) );
					assertThat( session.createQuery( "select cast('T' as TrueFalse)", Boolean.class ).getSingleResult(),
							is( true ) );
					assertThat( session.createQuery( "select cast('F' as TrueFalse)", Boolean.class ).getSingleResult(),
							is( false ) );
				}
		);
	}
	...
	public void testCastStringToBoolean(SessionFactoryScope scope) {
		scope.inTransaction( session -> {
			...
			assertThat( session.createQuery( "select cast('0' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('y' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('n' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('Y' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('N' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('t' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('f' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('T' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('F' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('true' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('false' as Boolean)", Boolean.class ).getSingleResult(),
					is( false ) );
			assertThat( session.createQuery( "select cast('TRUE' as Boolean)", Boolean.class ).getSingleResult(),
					is( true ) );
			assertThat( session.createQuery( "select cast('FALSE' as Boolean)", Boolean.class ).getSingleResult(),
	...
	public void testCastToOffsetDatetime(SessionFactoryScope scope) {
		scope.inTransaction( session -> {
			session.createQuery( "select cast(datetime 1911-10-09 12:13:14-02:00 as String)", String.class )
					.getSingleResult();
			session.createQuery( "select cast('1911-10-09 12:13:14.123-02:00' as OffsetDateTime)",
	...
	public void testCastDoubleToString(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select str(123.12)", String.class ).getSingleResult(),
							is( "123.12" ) );
					assertThat( session.createQuery( "select cast(123.12 as String)", String.class ).getSingleResult(),
							is( "123.12" ) );
					assertThat( session.createQuery( "select cast(123.12d as String)", String.class ).getSingleResult(),
							is( "123.12" ) );
					assertThat( session.createQuery( "select cast(123.12f as String)", String.class ).getSingleResult(),
							is( "123.12" ) );
					assertThat(
							session.createQuery( "select cast('123.12' as Double)", Double.class ).getSingleResult(),
							is( 123.12d ) );
					assertThat( session.createQuery( "select cast('123.12' as Float)", Float.class ).getSingleResult(),
							is( 123.12f ) );
				}
	...
	@SkipForDialect(dialectClass = OracleDialect.class,
			reason = "Oracle treats the cast value as a hexadecimal literal")
	...
	public void testCastFunctionWithLength(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					session.createQuery(
									"select cast(e.theString as String(15)), cast(e.theDouble as String(17)) from EntityOfBasics e",
									Object[].class )
							.list();
					assertEquals( 'A',
	...
	@SkipForDialect(dialectClass = PostgreSQLDialect.class, matchSubTypes = true,
			reason = "PostgreSQL bytea doesn't have a length")
	@SkipForDialect(dialectClass = CockroachDialect.class, matchSubTypes = true,
			reason = "CockroachDB bytes doesn't have a length")
	...
	@SkipForDialect(dialectClass = DB2Dialect.class, majorVersion = 10, minorVersion = 5,
			reason = "On this version the length of the cast to the parameter appears to be > 2")
	@SkipForDialect(dialectClass = AltibaseDialect.class, reason = "Altibase cast to raw does not do truncatation")
	@SkipForDialect(dialectClass = HSQLDialect.class,
			reason = "HSQL interprets string as hex literal and produces error")
	...
	public void testStrFunction(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					if ( !(session.getJdbcServices().getDialect() instanceof GaussDBDialect) ) {
						assertThat(
								session.createQuery( "select str(date 1911-10-09)", String.class ).getSingleResult(),
								is( "1911-10-09" ) );
					}
					assertThat( session.createQuery( "select str(time 12:13:14)", String.class ).getSingleResult(),
							anyOf( is( "12:13:14" ), is( "12:13:14.0000" ), is( "12.13.14" ) ) );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery(
									...
									Object[].class )
							.list();
					assertThat( session.createQuery( "select least(1,2,-1,3,4)", Integer.class ).getSingleResult(),
							is( -1 ) );
					assertThat( session.createQuery( "select greatest(1,2,-1,30,4)", Integer.class ).getSingleResult(),
							is( 30 ) );
				}
		);
	}
	...
	public void testStatisticalFunctions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> session.createQuery(
								"select var_samp(e.theDouble), var_pop(abs(e.theDouble)), stddev_samp(e.theDouble), stddev_pop(e.theDouble) from EntityOfBasics e",
								Object[].class )
						.list()
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select local time, local date, local datetime from EntityOfBasics",
							...
							.list();
					session.createQuery(
									"from EntityOfBasics e where e.theDate > current_date and e.theTime > current_time and e.theTimestamp > current_timestamp",
									EntityOfBasics.class )
							.list();
					session.createQuery(
									"from EntityOfBasics e where e.theDate > local date and e.theTime > local time and e.theTimestamp > local datetime",
									EntityOfBasics.class )
							.list();
	...
	public void testJpqlFunctionSyntax(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat( session.createQuery( "select function('lower','HIBERNATE')", String.class )
									.getSingleResult(),
							equalTo( "hibernate" ) );
					assertThat( session.createQuery( "select function(lower as String,'HIBERNATE')", String.class )
									.getSingleResult(),
							equalTo( "hibernate" ) );
					assertThat( session.createQuery( "select 1 where function('lower','HIBERNATE') = 'hibernate'",
									Integer.class ).getSingleResult(),
							equalTo( 1 ) );
					assertThat( session.createQuery( "select function('current_user')", String.class ).getSingleResult()
									.toLowerCase(),
							isOneOf( "hibernate_orm_test", "hibernateormtest", "sa", "hibernateormtest@%",
									"hibernate_orm_test@%", "root@%" ) );
					assertThat( session.createQuery( "select function(current_user as String)", String.class )
									.getSingleResult().toLowerCase(),
							isOneOf( "hibernate_orm_test", "hibernateormtest", "sa", "hibernateormtest@%",
									"hibernate_orm_test@%", "root@%" ) );
					assertThat( session.createQuery( "select lower(function('current_user'))", String.class )
									.getSingleResult(),
							isOneOf( "hibernate_orm_test", "hibernateormtest", "sa", "hibernateormtest@%",
									"hibernate_orm_test@%", "root@%" ) );
					session.createQuery( "select 1 where function('current_user') = 'hibernate_orm_test'",
							Integer.class ).getSingleResultOrNull();
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					assertEquals( LocalDateTime.of( 1974, 3, 23, 0, 0, 28, 123_000_000 ),
							session.createQuery( "select datetime 1974-03-23 00:00:15 + 13.123 second",
											LocalDateTime.class )
									.getSingleResult() );
				}
		);
	...
	public void testAddNanoseconds(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( LocalDateTime.of( 1974, 3, 23, 0, 0, 28, 123_000_000 ),
							session.createQuery( "select datetime 1974-03-23 00:00:15 + 13_123_000_000 nanosecond",
											LocalDateTime.class )
									.getSingleResult() );
				}
		);
	...
	public void testDiffMillisecondsAndNanoseconds(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat(
							session.createQuery(
											"select (datetime 1974-03-23 00:00:15 - datetime 1974-03-23 00:00:12.123) by second",
											Long.class )
									.getSingleResult(),
							anyOf( is( 3L ), is( 2L ) ) );
					assertEquals( 2_877_000_000L,
							session.createQuery(
											"select (datetime 1974-03-23 00:00:15 - datetime 1974-03-23 00:00:12.123) by nanosecond",
											Long.class )
									.getSingleResult() );
				}
		);
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery( "select timestampadd(month,2,current date) from EntityOfBasics e", Date.class )
							.list();
					session.createQuery(
									"select timestampdiff(hour,e.theTimestamp,current timestamp) from EntityOfBasics e",
									Long.class )
							.list();

					assertThat(
							session.createQuery( "select timestampadd(day, 5, local datetime)", LocalDateTime.class )
									.getSingleResult(),
							is( instanceOf( LocalDateTime.class ) )
					);
					assertThat(
							session.createQuery( "select timestampdiff(day, local datetime, local datetime)",
	...
	@SkipForDialect(dialectClass = CockroachDialect.class,
			reason = "unsupported binary operator: <timestamptz> - <date>")
	public void testDateAddDiffFunctions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery( "select dateadd(day, 5, local datetime)", LocalDateTime.class )
									.getSingleResult(),
							is( instanceOf( LocalDateTime.class ) )
					);
					assertThat(
							session.createQuery( "select datediff(day, local date, local datetime)", Long.class )
									.getSingleResult(),
							is( instanceOf( Long.class ) )
					);
				}
	...
	public void testDatediffFunctionMySQL(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery(
									"select datediff(datetime 1999-07-19 00:00, datetime 1999-07-23 23:59)",
									Integer.class ).getSingleResult(),
		...
		scope.inTransaction(
				session -> {
					assertEquals( Duration.of( 3, ChronoUnit.SECONDS ).plus( Duration.of( 23, ChronoUnit.MILLIS ) ),
							session.createQuery( "select e.theDuration from EntityOfBasics e", Duration.class )
									.getSingleResult() );
					assertEquals( Duration.of( 3, ChronoUnit.SECONDS )
									.plus( Duration.of( 23, ChronoUnit.MILLIS ).plus( Duration.of( 21, ChronoUnit.SECONDS ) ) ),
							session.createQuery( "select e.theDuration + 21 second from EntityOfBasics e",
											Duration.class )
									.getSingleResult() );
					assertEquals( Duration.of( 3, ChronoUnit.SECONDS )
									.plus( Duration.of( 23, ChronoUnit.MILLIS ).plus( Duration.of( 2, ChronoUnit.DAYS ) ) ),
	...
	@SkipForDialect(dialectClass = AltibaseDialect.class,
			reason = "Altibase returns 2025-03-31 as a result of select {2024-02-29} + 13 month")
	...
	@SkipForDialect(dialectClass = GaussDBDialect.class,
			reason = "type:resolved.interval_mul result month: 0.000000, day: 432000000000000.000000 overflow")
	public void testDurationArithmeticWithLiterals(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertEquals( 25L,
							session.createQuery(
											"select (datetime 1974-03-23 5:30:25 - datetime 1974-03-23 5:30:00) by second",
											Long.class )
									.getSingleResult() );
					assertEquals( 25L * 1000000000,
							session.createQuery(
											"select (datetime 1974-03-23 5:30:25 - datetime 1974-03-23 5:30:00) by nanosecond",
											Long.class )
									.getSingleResult() );
					...
					assertEquals( 10L,
							session.createQuery(
											"select (datetime 1974-03-23 5:30:25 - datetime 1974-03-23 5:20:25) by minute",
											Long.class )
									.getSingleResult() );
					assertEquals( 10L * 60,
							session.createQuery(
											"select (datetime 1974-03-23 5:30:25 - datetime 1974-03-23 5:20:25) by second",
											Long.class )
									.getSingleResult() );
				}
		);
				...
				session -> {
					...
					assertEquals( Duration.ofHours( 2 ),
							session.createQuery( "select time 5:30:30 - time 3:30:30" )
									.getSingleResult() );
					assertEquals(
							Duration.ofHours( 1 ).plus( Duration.ofMinutes( 10 ).plus( Duration.ofSeconds( 20 ) ) ),
				...
				session -> {
					assertEquals( Duration.ofDays( 35 ),
							session.createQuery( "select local date 1990-2-5 - local date 1990-1-1" )
									.getSingleResult() );
					assertEquals( Duration.ofDays( 35 ).plus( Duration.ofHours( 1 )
									.plus( Duration.ofMinutes( 10 ).plus( Duration.ofSeconds( 20 ) ) ) ),
							session.createQuery(
											"select local datetime 1990-2-5 5:30:30 - local datetime 1990-1-1 4:20:10" )
									.getSingleResult() );
					assertEquals( Duration.ofDays( 28 ).plus( Duration.ofHours( 2 )
									.plus( Duration.ofMinutes( 20 ).plus( Duration.ofSeconds( 10 ) ) ) ),
							session.createQuery(
											"select (local datetime 1990-2-5 5:30:30 - local datetime 1990-1-1 4:20:10) - 7 day + 10 minute - 10 second + 1 hour" )
									.getSingleResult() );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					session.createQuery( "select current_timestamp - e.theTimestamp from EntityOfBasics e" )
							.list();
					session.createQuery(
									"select current_timestamp - (current_timestamp - e.theTimestamp) from EntityOfBasics e" )
							.list();
					assertEquals( LocalDateTime.of( 1990, 1, 1, 12, 30, 0 ),
							session.createQuery(
											"select local datetime - (local datetime - local datetime 1990-1-1 12:30:00)" )
									.getSingleResult() );
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					...
					session.createQuery(
							...
							.list();
					session.createQuery(
									"select extract(time from local datetime), extract(date from local datetime) from EntityOfBasics e",
									Object[].class )
							.list();
					...
					assertThat( session.createQuery( "select extract(year from date 1974-03-25)", Integer.class )
							.getSingleResult(), is( 1974 ) );
					assertThat( session.createQuery( "select extract(month from date 1974-03-25)", Integer.class )
							.getSingleResult(), is( 3 ) );
					assertThat( session.createQuery( "select extract(day from date 1974-03-25)", Integer.class )
							.getSingleResult(), is( 25 ) );

					assertThat( session.createQuery( "select extract(hour from time 12:30)", Integer.class )
							.getSingleResult(), is( 12 ) );
					assertThat( session.createQuery( "select extract(minute from time 12:30)", Integer.class )
							.getSingleResult(), is( 30 ) );
				}
		);
	}
	...
	public void testExtractFunctionEpoch(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery( "select extract(epoch from datetime 1974-03-23 12:35)", Long.class )
									.getSingleResult(), is( 133274100L ) );
				}
		);
	}
	...
	public void testExtractOffsetHourMinute(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( 3,
							session.createQuery(
											"select extract(offset hour from offset datetime 2024-2-5 12:30:12+03:12)",
											Integer.class )
									.getSingleResult() );
					assertEquals( 12,
							session.createQuery(
											"select extract(offset minute from offset datetime 2024-2-5 12:30:12+03:12)",
											Integer.class )
									.getSingleResult() );
				}
		);
	...
	public void testExtractFunctionWithAssertions(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertThat(
							session.createQuery(
									"select extract(week of year from date 2019-01-01) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 1 )
					);
					assertThat(
							session.createQuery(
									"select extract(week of year from date 2019-01-05) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 1 )
					);
					assertThat(
							session.createQuery(
									"select extract(week of year from date 2019-01-06) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 2 )
					);
					...
					assertThat(
							session.createQuery(
									"select extract(week of month from date 2019-05-01) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 1 )
					);
					assertThat(
							session.createQuery(
									"select extract(week of month from date 2019-05-04) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 1 )
					);
					assertThat(
							session.createQuery(
									"select extract(week of month from date 2019-05-05) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 2 )
					);

					assertThat(
							session.createQuery( "select extract(week from date 2019-05-27) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 22 )
					);
					assertThat(
							session.createQuery( "select extract(week from date 2019-06-02) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 22 )
					);
					assertThat(
							session.createQuery( "select extract(week from date 2019-06-03) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 23 )
					);

					assertThat(
							session.createQuery( "select extract(day of year from date 2019-05-30) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 150 )
					);
					assertThat(
							session.createQuery(
									"select extract(day of month from date 2019-05-27) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 27 )
					);

					assertThat(
							session.createQuery( "select extract(day from date 2019-05-31) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 31 )
					);
					assertThat(
							session.createQuery( "select extract(month from date 2019-05-31) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 5 )
					);
					assertThat(
							session.createQuery( "select extract(year from date 2019-05-31) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 2019 )
					);
					assertThat(
							session.createQuery( "select extract(quarter from date 2019-05-31) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 2 )
					);

					assertThat(
							session.createQuery( "select extract(day of week from date 2019-05-27) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 2 )
					);
					assertThat(
							session.createQuery( "select extract(day of week from date 2019-05-31) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 6 )
					);

					assertThat(
							session.createQuery( "select extract(second from time 14:12:10) from EntityOfBasics",
									Float.class ).getResultList().get( 0 ),
							is( 10f )
					);
					assertThat(
							session.createQuery( "select extract(minute from time 14:12:10) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 12 )
					);
					assertThat(
							session.createQuery( "select extract(hour from time 14:12:10) from EntityOfBasics",
									Integer.class ).getResultList().get( 0 ),
							is( 14 )
					);

					assertThat(
							session.createQuery( "select extract(date from local datetime) from EntityOfBasics",
									LocalDate.class ).getResultList().get( 0 ),
							instanceOf( LocalDate.class )
					);
					assertThat(
							session.createQuery( "select extract(time from local datetime) from EntityOfBasics",
									LocalTime.class ).getResultList().get( 0 ),
	...
	public void testFormat(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery(
									"select format(theDate as 'EEEE, dd/MM/yyyy') from EntityOfBasics where id=123",
	...
	public void testFormatTime(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					assertThat(
							session.createQuery(
									"select format(theTime as '''Hello'', hh:mm:ss a') from EntityOfBasics where id=123",
									String.class ).getResultList().get( 0 ),
	...
	public void testMedian(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( 1.0,
							session.createQuery( "select median(e.theDouble) from EntityOfBasics e", Double.class )
									.getSingleResult(),
							1e-5 );
					assertEquals( 5.0,
							session.createQuery( "select median(e.theInt) from EntityOfBasics e", Double.class )
									.getSingleResult(),
							1e-5 );
					List<Object[]> list = session.createQuery(
									"select median(e.theDouble), median(e.theInt) from EntityOfBasics e", Object[].class )
							.list();
	...
	public void testHyperbolic(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( Math.sinh( 1 ),
							session.createQuery( "select sinh(e.theDouble) from EntityOfBasics e", Double.class )
									.getSingleResult(), 1e-6 );
					assertEquals( Math.cosh( 1 ),
							session.createQuery( "select cosh(e.theDouble) from EntityOfBasics e", Double.class )
									.getSingleResult(), 1e-6 );
					assertEquals( Math.tanh( 1 ),
							session.createQuery( "select tanh(e.theDouble) from EntityOfBasics e", Double.class )
									.getSingleResult(), 1e-6 );
				}
		);
	}
	...
	public void testGrouping(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> session.createQuery(
								"select max(e.theDouble), e.gender, e.theInt from EntityOfBasics e group by e.gender, e.theInt",
								Object[].class )
						.list()
		);
	}
	...
	public void testGroupByRollup(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> session.createQuery(
								"select avg(e.theDouble), e.gender, e.theInt from EntityOfBasics e group by rollup(e.gender, e.theInt)",
								Object[].class )
						.list()
		);
	}
	...
	public void testGroupByGroupingSets(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> session.createQuery(
								"select avg(e.theDouble), e.gender, e.theInt from EntityOfBasics e group by cube(e.gender, e.theInt)",
								Object[].class )
						.list()
		);
	}
	...
	public void testMaxGreatest(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( 10L, session.createQuery(
									"select greatest((select max(someLong) from SimpleEntity), (select max(someInteger) from SimpleEntity))",
									Long.class )
							.getSingleResult() );
				}
		);
	...
	public void testMaxOverUnion(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( 10L, session.createQuery(
									"select max(val) from (select someLong as val from SimpleEntity union select someInteger as val from SimpleEntity)",
									Long.class )
							.getSingleResult() );
				}
		);
	...
	public void testEnumIsNull(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					...
					session.createSelectionQuery( "from EntityOfBasics where :gender is null" )
							.setParameter( "gender", EntityOfBasics.Gender.MALE ).getResultList();
				}
		);
	}
	...
	public void testInstantiateLocalClass(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					session.createSelectionQuery( "select new Pair(theInt, theDouble) from EntityOfBasics", Pair.class )
							.getResultList();
					session.createSelectionQuery(
							"select new Triple(theInt as integer, theDouble as floating, 'hello' as string) from EntityOfBasics",
							Triple.class ).getResultList();
				}
		);
	}
		...
		scope.inTransaction(
				session -> {
					assertEquals( List.of( 1 ),
							session.createSelectionQuery(
											"select 1 from EntityOfBasics where (theInt, theDouble) = (5, 1.0)", Integer.class )
									.getResultList() );
					assertEquals( List.of(),
							session.createSelectionQuery(
											"select 1 from EntityOfBasics where (theInt, theDouble) = (1, 1.0)", Integer.class )
									.getResultList() );
					assertEquals( List.of( 1 ),
							session.createSelectionQuery(
											"select 1 from EntityOfBasics where (theInt, theDouble) > (1, 1.0)", Integer.class )
	...
	public void testTupleComparisonWithParameters(SessionFactoryScope scope) {
		scope.inTransaction(
				session -> {
					assertEquals( List.of( 1 ),
							session.createSelectionQuery(
											"select 1 from EntityOfBasics where (theInt, theDouble) = (:int, :float)",
											Integer.class )
									.setParameter( "int", 5 )
		...
		scope.inTransaction(
				session -> {
					assertEquals( List.of( true ),
							session.createSelectionQuery(
											"select (5, 'stringy') in (select theInt, theString from EntityOfBasics)",
											Boolean.class )
									.getResultList() );
					assertEquals( List.of( false ),
							session.createSelectionQuery(
											"select (5, 'hello') in (select theInt, theString from EntityOfBasics)",
											Boolean.class )
									.getResultList() );
				}
		);
	...
	public void testColumnFunction(SessionFactoryScope scope) {
		scope.inTransaction( s -> {
			...
			assertEquals( "the string",
					s.createSelectionQuery( "select column(e.'the_column') from EntityOfBasics e", String.class )
							.getSingleResultOrNull() );
			s.createSelectionQuery( "from EntityOfBasics e where column(e.the_column as String) = 'the string'",
							EntityOfBasics.class )
					.getSingleResult();
		} );
	}
	...
	public void testUUIDColumnFunction(SessionFactoryScope scope) {
		scope.inTransaction( s -> {
			byte[] bytes = s.createSelectionQuery( "select column(e.theuuid as binary) from EntityOfBasics e",
							byte[].class )
					.getSingleResultOrNull();
...
//					.getSingleResultOrNull();
	...
	public void testCtidColumnFunction(SessionFactoryScope scope) {
		scope.inTransaction( s -> {
			String string = s.createSelectionQuery( "select column(e.ctid as String) from EntityOfBasics e",
							String.class )
					.getSingleResultOrNull();
			byte[] bytes = s.createSelectionQuery( "select column(e.ctid as binary) from EntityOfBasics e",
							byte[].class )
					.getSingleResultOrNull();
		} );
	}
