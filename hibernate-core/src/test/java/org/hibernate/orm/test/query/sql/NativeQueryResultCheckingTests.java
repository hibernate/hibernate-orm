...
public class NativeQueryResultCheckingTests {
	...
	public void testOneColumn(SessionFactoryScope scope) {
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select isbn from books", String.class )
		...
		scope.inTransaction(
				session ->
						assertThrows( IllegalArgumentException.class,
								() -> session.createNativeQuery( "select isbn from books", Integer.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		);
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select isbn from books", Object[].class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		);
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select isbn from books", Tuple.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		);
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select isbn from books", Map.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		);
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select isbn from books" )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		);
	...
	public void testTwoStringColumns(SessionFactoryScope scope) {
		scope.inTransaction(
				session ->
						assertThrows( IllegalArgumentException.class,
								() -> session.createNativeQuery( "select name, isbn from books", String.class )
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select name, isbn from books", Object[].class )
										.addScalar( "name", String.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select name, isbn from books", Tuple.class )
										.addScalar( "name", String.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select name, isbn from books", Map.class )
										.addScalar( "name", String.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select name, isbn from books" )
										.addScalar( "name", String.class )
										.addScalar( "isbn", String.class )
										.getResultList()
						)
		...
		scope.inTransaction(
				session ->
						assertThrows( IllegalArgumentException.class,
								() -> session.createNativeQuery( "select name, isbn from books", Book.class )
	...
	public void testOkMutateResultSetMappingWithBook(SessionFactoryScope scope) {
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> session.createNativeQuery( "select id, name from books", Book.class )
	...
	public void testAllColumns(SessionFactoryScope scope) {
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> {
									session.createNativeQuery( "select * from books", Object[].class )
											.addScalar( "id", Integer.class )
											.addScalar( "name", String.class )
											.getResultList();
								}
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> {
									session.createNativeQuery( "select * from books", Tuple.class )
											.addScalar( "id", Integer.class )
											.addScalar( "name", String.class )
											.getResultList();
								}
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> {
									session.createNativeQuery( "select * from books", Map.class )
											.addScalar( "id", Integer.class )
											.addScalar( "name", String.class )
											.getResultList();
								}
		...
		scope.inTransaction(
				session ->
						assertDoesNotThrow(
								() -> {
									session.createNativeQuery( "select * from books", List.class )
											.addScalar( "id", Integer.class )
											.addScalar( "name", String.class )
											.getResultList();
								}
	...
	public void testRecordWithPrimitiveField(SessionFactoryScope scope) {
		scope.inTransaction(
				session ->
					assertDoesNotThrow(
							() -> session.createNativeQuery( "select id, name from persons", Record.class)
