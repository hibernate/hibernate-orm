...
@DomainModel(
		annotatedClasses = {
				ReferencedColumnQuotingTest2.User.class,
				ReferencedColumnQuotingTest2.Position2.class,
				ReferencedColumnQuotingTest2.JobPosition.class,
				ReferencedColumnQuotingTest2.Job2Position.class
		}
)
@SessionFactory
@ServiceRegistry(
		settings = @Setting(name = GLOBALLY_QUOTED_IDENTIFIERS, value = "true")
)
@Jira("https://hibernate.atlassian.net/browse/HHH-9035")
public class ReferencedColumnQuotingTest2 {
	...
	public static class Job2Position {
		...
		@JoinColumn(name = "JobPosition+id", referencedColumnName = "JobPosition+id")
