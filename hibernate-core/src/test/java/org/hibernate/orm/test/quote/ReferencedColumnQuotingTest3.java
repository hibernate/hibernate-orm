...
@DomainModel(
		annotatedClasses = {
				ReferencedColumnQuotingTest3.User.class,
				ReferencedColumnQuotingTest3.Position2.class,
				ReferencedColumnQuotingTest3.JobPosition.class,
				ReferencedColumnQuotingTest3.Job2Position.class
		}
)
@SessionFactory
