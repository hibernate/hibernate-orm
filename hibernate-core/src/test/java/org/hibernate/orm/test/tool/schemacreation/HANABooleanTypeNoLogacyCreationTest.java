 ...
 */
public class HANABooleanTypeNoLogacyCreationTest extends AbstractHANAStringAndBooleanFieldsCreationTest {

	@Override
	protected void applySettings(StandardServiceRegistryBuilder serviceRegistryBuilder) {
		super.applySettings( serviceRegistryBuilder );
		serviceRegistryBuilder.applySetting( "hibernate.dialect.hana.use_legacy_boolean_type", "false" );
	}

	@SchemaTest
	@TestForIssue(jiraKey = "HHH-12132")
	public void testTargetScriptIsCreatedBooleanType(SchemaScope scope) throws Exception {
