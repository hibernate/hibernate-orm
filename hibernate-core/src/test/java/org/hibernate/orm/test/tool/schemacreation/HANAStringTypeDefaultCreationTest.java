 ...
 */
public class HANAStringTypeDefaultCreationTest extends AbstractHANAStringAndBooleanFieldsCreationTest {

	@SchemaTest
	@TestForIssue(jiraKey = "HHH-12302")
	public void testTargetScriptIsCreatedStringTypeDefault(SchemaScope scope) throws Exception {
