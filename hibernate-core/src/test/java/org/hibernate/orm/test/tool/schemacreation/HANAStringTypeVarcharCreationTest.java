 ...
 */
public class HANAStringTypeVarcharCreationTest extends AbstractHANAStringAndBooleanFieldsCreationTest {

	@Override
	protected void applySettings(StandardServiceRegistryBuilder serviceRegistryBuilder) {
		super.applySettings( serviceRegistryBuilder );
		serviceRegistryBuilder.applySetting( "hibernate.dialect.hana.use_nvarchar_string_type", "false" );
	}

	@SchemaTest
	@TestForIssue(jiraKey = "HHH-12302")
	public void testTargetScriptIsCreatedStringTypeVarchar(SchemaScope scope) throws Exception {
