 ...
 */
package org.hibernate.orm.test.xml.collectionpk;
...
public class CollectionPkTest {
	...
	public void testSet() {
		verifyPkNameUsed(
				"org/hibernate/orm/test/xml/collectionpk/person_set.orm.xml",
	...
	public void testMap() {
		verifyPkNameUsed(
				"org/hibernate/orm/test/xml/collectionpk/person_map.orm.xml",
