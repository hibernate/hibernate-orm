...
//	@FailureExpected( jiraKey = "HHH-10208" )
	public void testOneToMany() throws Exception {
		verifyIndexCreated(
				"org/hibernate/orm/test/xml/index/person_manytoone.orm.xml",
...
//	@FailureExpected( jiraKey = "HHH-10208" )
	public void testProperty() throws Exception {
		verifyIndexCreated(
				"org/hibernate/orm/test/xml/index/person_property.orm.xml",
				"person_name_index"
		);
	}
	...
	public void testPropertyColumn() throws Exception {
		verifyIndexCreated(
				"org/hibernate/orm/test/xml/index/person_propertycolumn.orm.xml",
				"person_name_index"
		);
	}
}
