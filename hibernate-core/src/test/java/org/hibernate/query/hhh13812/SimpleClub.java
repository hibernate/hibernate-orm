...
//    @OrderBy("SUBSTRING( teamTypeCode, 1, 1) ASC, SUBSTRING( teamTypeCode, 2, 2 ) DESC, SUBSTRING( teamTypeCode, 4, 1 ) DESC, ordinalNbr")  // works, but not what we want
    // sort by 2-digit age group: anything over ('O') shall come before any age group under ('U'), which leads to O20 coming first, then O35, O40, O45, ... O65 then U20, U18, U16, ... U08 -> understood?
