...
public class JPAOverriddenAnnotationReaderTest extends BaseUnitTestCase {
	...
	public void testMappedSuperclassAnnotations() throws Exception {
		...
		JPAOverriddenAnnotationReader reader = new JPAOverriddenAnnotationReader( Organization.class, context, bootstrapContext );
	...
	public void testEntityRelatedAnnotations() throws Exception {
		...
		JPAOverriddenAnnotationReader reader = new JPAOverriddenAnnotationReader( Administration.class, context, bootstrapContext );
		...
		reader = new JPAOverriddenAnnotationReader( Match.class, context, bootstrapContext );
		assertNotNull( reader.getAnnotation( Table.class ) );
		assertEquals(
		...
		reader = new JPAOverriddenAnnotationReader( Competition.class, context, bootstrapContext );
		assertNotNull( reader.getAnnotation( MappedSuperclass.class ) );

		reader = new JPAOverriddenAnnotationReader( TennisMatch.class, context, bootstrapContext );
		...
		reader = new JPAOverriddenAnnotationReader( SocialSecurityPhysicalAccount.class, context, bootstrapContext );
	...
	public void testEntityRelatedAnnotationsMetadataComplete() throws Exception {
		...
		reader = new JPAOverriddenAnnotationReader( SocialSecurityMoralAccount.class, context, bootstrapContext );
	...
	public void testIdRelatedAnnotations() throws Exception {
		...
		JPAOverriddenAnnotationReader reader = new JPAOverriddenAnnotationReader( method, context, bootstrapContext );
		...
		reader = new JPAOverriddenAnnotationReader( field, context, bootstrapContext );
		...
		reader = new JPAOverriddenAnnotationReader( method, context, bootstrapContext );
		assertNotNull(
	...
	public void testBasicRelatedAnnotations() throws Exception {
		...
		JPAOverriddenAnnotationReader reader = new JPAOverriddenAnnotationReader( field, context, bootstrapContext );
	...
	public void testEntityListeners() throws Exception {
		...
		reader = new JPAOverriddenAnnotationReader( Administration.class, context, bootstrapContext );
