package org.hibernate.test.bytecode.enhancement.initializeBeforeWrite;
...
public class InitializeBeforeWriteVersionedEntityTest extends BaseCoreFunctionalTestCase {
    ...
    public void test() {
        doInJPA(this::sessionFactory, em -> {
            ...
            assertTrue( isInitialized( entity ) );
            assertTrue( Hibernate.isPropertyInitialized( entity, "id" ) );
            assertTrue( Hibernate.isPropertyInitialized( entity, "name" ) );
            assertTrue( Hibernate.isPropertyInitialized( entity, "version" ) );
