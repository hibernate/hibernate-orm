 ...
 * Negative test when specifying a type that can't be mapped as a collection
 */
public class UserWithUnimplementedCollectionTest extends BaseCoreFunctionalTestCase {
    ...
    protected void buildSessionFactory() {
        try {
            ...
            assertEquals("Illegal attempt to map a non collection as a @OneToMany, @ManyToMany or @CollectionOfElements: org.hibernate.test.collection.custom.declaredtype.UserWithUnimplementedCollection.emailAddresses", e.getMessage());
        }
    }
