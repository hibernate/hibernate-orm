...
import org.hibernate.hql.spi.id.subselect.SubSelectBulkIdStrategy;
 ...
 */
public class SubSelectBulkIdTest extends BaseCoreFunctionalTestCase {
	...
	protected Configuration constructConfiguration() {
		...
		configuration.setProperty( AvailableSettings.HQL_BULK_ID_STRATEGY, SubSelectBulkIdStrategy.class.getName() );
