	...
	public void testTypeContribution() {
		doInJPA( this::entityManagerFactory, entityManager -> {
			try {
				...
				fail("Should have thrown exception because UUID is registered as Types.OTHER by default");
			}
			catch (Exception expected) {
				assertEquals( "org.hibernate.HibernateException: Unknown wrap conversion requested: org.postgresql.util.PGobject to java.util.UUID", expected.getMessage() );
			}
		} );
	}
