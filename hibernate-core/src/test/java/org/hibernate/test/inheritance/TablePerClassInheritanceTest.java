...
import static org.hibernate.test.inheritance.TablePerClassInheritanceTest.Author;
import static org.hibernate.test.inheritance.TablePerClassInheritanceTest.Book;
import static org.hibernate.test.inheritance.TablePerClassInheritanceTest.SpellBook;
...
public class TablePerClassInheritanceTest {
	...
	public void testUpdateAndDelete(SessionFactoryScope scope) {
		...
		scope.inTransaction( s -> {
			s.createQuery( "delete Book where title='Necronomicon II'" ).executeUpdate();
		} );
