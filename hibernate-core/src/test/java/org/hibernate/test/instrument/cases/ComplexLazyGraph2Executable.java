...
public class ComplexLazyGraph2Executable extends AbstractExecutable {
	@Override
				...
				new Consumer<Session>() {
					...
					public void accept(Session session) {
						try {
							...
							assertThat(myD, instanceOf(HibernateProxy.class));

							System.out.println("Property-Value: " + myD.getD());
							System.out.println("######################################################");

							assertThat( myD.getA(), not( instanceOf( HibernateProxy.class ) ) );
...
//						assertThat( stats.getPrepareStatementCount(), is( 1 ) );
	...
	protected void applyAnnotatedClasses(Configuration cfg) {
		...
		cfg.addAnnotatedClass( AEntity2.class );
		cfg.addAnnotatedClass( BEntity2.class );
		cfg.addAnnotatedClass( CEntity2.class );
		cfg.addAnnotatedClass( DEntity2.class );
		cfg.addAnnotatedClass( EEntity2.class );
	}
