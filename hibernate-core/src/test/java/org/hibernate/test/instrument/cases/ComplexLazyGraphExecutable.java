...
public class ComplexLazyGraphExecutable extends AbstractExecutable {
	@Override
...
//						assertThat( stats.getPrepareStatementCount(), is( 1 ) );
	...
	protected void applyAnnotatedClasses(Configuration cfg) {
		...
		cfg.addAnnotatedClass( AEntity.class );
		cfg.addAnnotatedClass( BEntity.class );
		cfg.addAnnotatedClass( CEntity.class );
		cfg.addAnnotatedClass( DEntity.class );
		cfg.addAnnotatedClass( EEntity.class );
	}
