...
public abstract class AbstractTransformingClassLoaderInstrumentTestCase extends BaseUnitTestCase {
	...
	public void testComplexLazyGraph2() {
		executeExecutable( "org.hibernate.test.instrument.cases.ComplexLazyGraph2Executable" );
	}
	...
	public void testComplexLazyGraphHbm2() {
		executeExecutable( "org.hibernate.test.instrument.cases.ComplexLazyGraphHbm2Executable" );
	}
