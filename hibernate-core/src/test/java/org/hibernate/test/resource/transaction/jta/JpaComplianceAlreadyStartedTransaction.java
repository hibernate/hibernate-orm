 ...
 */
public class JpaComplianceAlreadyStartedTransaction extends BaseNonConfigCoreFunctionalTestCase {
	...
	public void noIllegalStateExceptionShouldBeThrownWhenBeginTxIsCalledWithAnActiveOne() throws Exception {
		tm.begin();
