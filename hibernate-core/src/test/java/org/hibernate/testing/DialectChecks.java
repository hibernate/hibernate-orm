...
/**
 * NuoDB: 22-Jul023 - OVERRIDE.<br/>
 * Copy of class from hibernate-testing so that we can modify it.
 * <p>
...
abstract public class DialectChecks {
    ...
    public static class SupportsJdbcDriverProxying implements DialectCheck {
        public boolean isMatch(Dialect dialect) {
            return !(
                // NuoDB: 22-Jul-23
                dialect instanceof DB2Dialect || dialect instanceof NuoDBDialect
            );
        }
    }
    ...
    public static class SupportsNClob implements DialectCheck {
        ...
        public boolean isMatch(Dialect dialect) {
            return !(
                ...
                dialect instanceof NuoDBDialect
            );
        }
    }
