...
abstract class AbstractEhcacheAccessStrategy<T extends EhcacheTransactionalDataRegion> {
	 ...
	 *
	 * @param region
	 *            The wrapped region. Accessible to subclasses via {@link #region()}
	 * @param settings
	 *            The Hibernate settings. Accessible to subclasses via
	 *            {@link #settings()}
	 */
	 ...
	 *      Object, Object, long, Object, boolean)
	 */
	public abstract boolean putFromLoad(SharedSessionContractImplementor session, Object key, Object value,
