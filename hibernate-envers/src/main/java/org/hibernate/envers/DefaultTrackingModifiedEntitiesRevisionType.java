...
/**
 * Extension of standard {@link DefaultRevisionType} that allows tracking entity names changed in each revision.
 ...
 */
@MappedSuperclass
public class DefaultTrackingModifiedEntitiesRevisionType extends DefaultRevisionType {
	...
	public boolean equals(Object o) {
		...
		if ( !(o instanceof DefaultTrackingModifiedEntitiesRevisionType) ) {
			return false;
		}
		if ( !super.equals( o ) ) {
			return false;
		...
		final DefaultTrackingModifiedEntitiesRevisionType that = (DefaultTrackingModifiedEntitiesRevisionType) o;
