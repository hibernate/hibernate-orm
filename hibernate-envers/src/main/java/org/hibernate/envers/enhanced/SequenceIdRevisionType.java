 ...
 */
@MappedSuperclass
public class SequenceIdRevisionType implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if ( !(o instanceof SequenceIdRevisionType) ) {
			return false;
		}

		final SequenceIdRevisionType that = (SequenceIdRevisionType) o;
