...
public abstract class AbstractAuditQuery implements AuditQueryImplementor {
	...
	public AuditAssociationQuery<? extends AuditQuery> createCriteria(String associationName) {
		...
		if (result == null) {
			result = new AuditAssociationQueryImplementor<AuditQueryImplementor>( enversService, versionsReader, this, qb, entityName, associationName, REFERENCED_ENTITY_ALIAS );
