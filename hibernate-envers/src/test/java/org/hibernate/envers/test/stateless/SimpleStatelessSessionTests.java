 ...
 */
package org.hibernate.envers.test.stateless;
...
public class SimpleStatelessSessionTests {
	...
	void simpleSession(SessionFactoryScope factoryScope) {
		...
		factoryScope.inTransaction( (session) -> {
			final Long count = session.createQuery( "select count(*) from org.hibernate.envers.test.stateless.SimpleStatelessSessionTests$Person_AUD", Long.class )
					.getSingleResult();
