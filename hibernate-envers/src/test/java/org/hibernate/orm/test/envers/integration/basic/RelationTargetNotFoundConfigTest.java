...
@Jpa(annotatedClasses = {
		RelationTargetNotFoundConfigTest.Foo.class,
		RelationTargetNotFoundConfigTest.Bar.class,
		RelationTargetNotFoundConfigTest.FooBar.class
}, integrationSettings = @Setting(name = EnversSettings.GLOBAL_RELATION_NOT_FOUND_LEGACY_FLAG, value = "false"))
public class RelationTargetNotFoundConfigTest {
	...
	public void testRelationTargetNotFoundAction(EntityManagerFactoryScope scope) {
		...
		scope.inTransaction( em -> em.createNativeStatement( "DELETE FROM FooBar_AUD WHERE id = 2" ).execute() );
