...
@Jpa(annotatedClasses = {
		RelationTargetNotFoundTest.Foo.class,
		RelationTargetNotFoundTest.Bar.class,
		RelationTargetNotFoundTest.FooBar.class
})
public class RelationTargetNotFoundTest {
	...
	public void testRelationTargetNotFoundAction(EntityManagerFactoryScope scope) {
		...
		scope.inEntityManager( em -> {
			...
			assertNull( Hibernate.unproxy( rev1.getFooBar2() ) );
		} );
		...
		scope.inEntityManager( em -> {
			...
			assertNotNull( rev1 );
			// With RelationTargetNotFoundAction.ERROR, this would throw an EntityNotFoundException
			assertNull( Hibernate.unproxy( rev1.getBar() ) );
		} );
	}
