...
@EnversTest
@Jpa(annotatedClasses = {StringMapLobTest.Simple.class})
...
@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "CUBRID cannot compare CLOB values with the = operator")
