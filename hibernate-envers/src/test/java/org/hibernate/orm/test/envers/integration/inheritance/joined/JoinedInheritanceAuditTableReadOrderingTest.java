...
public class JoinedInheritanceAuditTableReadOrderingTest extends BaseEnversJPAFunctionalTestCase {
	...
	public void initData() {
		Long id = fromTransaction( getEntityManager(), em -> {
		...
		inTransaction( getEntityManager(), em -> {
	...
	@Test
	public void testAuditRowsExist() {
		inTransaction( getEntityManager(), em -> {
	...
	@Test
	public void testJoinedAuditTableReadReturnsAllRowsEnvers() {
		inTransaction( getEntityManager(), em -> {
	...
	@Test
	public void testJoinedAuditTableReadReturnsAllRowsCustom() {
		inTransaction( getEntityManager(), em -> {
