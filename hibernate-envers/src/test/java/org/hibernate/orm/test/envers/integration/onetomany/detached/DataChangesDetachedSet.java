...
public class DataChangesDetachedSet {
	...
	public void testRevisionsCounts(EntityManagerFactoryScope scope) {
		scope.inEntityManager( em -> {
			...
			assertEquals( Arrays.asList( 1, 2 ), auditReader.getRevisions( SetRefCollEntity.class, coll1_id ) );
	...
	public void testHistoryOfColl1(EntityManagerFactoryScope scope) {
		scope.inEntityManager( em -> {
			...
			assertEquals( "coll2", rev2.getData() );
		} );
	}
}
