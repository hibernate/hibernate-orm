...
@Jpa(annotatedClasses = {
		AssociationToNotAuditedManyJoinQueryTest.EntityA.class,
		AssociationToNotAuditedManyJoinQueryTest.EntityB.class,
		AssociationToNotAuditedManyJoinQueryTest.EntityC.class
})
@EnversTest
public class AssociationToNotAuditedManyJoinQueryTest {
