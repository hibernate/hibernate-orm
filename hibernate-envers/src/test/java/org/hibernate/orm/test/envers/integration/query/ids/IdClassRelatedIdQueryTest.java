...
@Jpa(annotatedClasses = {
		IdClassRelatedIdQueryTest.Person.class,
		IdClassRelatedIdQueryTest.Document.class,
		IdClassRelatedIdQueryTest.PersonDocument.class
})
@EnversTest
@JiraKey(value = "HHH-11748")
public class IdClassRelatedIdQueryTest {
	@BeforeClassTemplate
