...
@Jpa(annotatedClasses = {
		RecordIdRelatedIdQueryTest.Person.class,
		RecordIdRelatedIdQueryTest.Document.class,
		RecordIdRelatedIdQueryTest.PersonDocument.class
})
@EnversTest
public class RecordIdRelatedIdQueryTest {
