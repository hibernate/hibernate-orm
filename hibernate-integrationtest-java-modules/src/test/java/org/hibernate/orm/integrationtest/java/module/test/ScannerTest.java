...
import org.hibernate.archive.scan.internal.JandexScanner;
...
public class ScannerTest {
	...
	public void verifyModuleInfoScanner() {
		...
		JandexScanner standardScanner = new JandexScanner( StandardArchiveDescriptorFactory.INSTANCE );
		...
		Assert.assertEquals( Author.class.getName(), classDescriptor.name() );
		Assert.assertEquals( ClassDescriptor.Categorization.MODEL, classDescriptor.categorization() );
	}
