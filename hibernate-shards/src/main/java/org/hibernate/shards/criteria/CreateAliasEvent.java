...
class CreateAliasEvent implements CriteriaEvent {
    ...
    private enum MethodSig {
        ...
        ASSOC_PATH_AND_ALIAS_AND_JOIN_TYPE_AND_WITH_CLAUSE
    }
    ...
    public CreateAliasEvent(final String associationPath, final String alias) {
        this(MethodSig.ASSOC_PATH_AND_ALIAS, associationPath, alias, null, null);
    }
     ...
     */
    public CreateAliasEvent(final String associationPath, final String alias, final JoinType joinType) {
     ...
     * @param alias           the name of the alias we're creating.
     * @param joinType        the join type of the alias we're creating.
     * @param withClause      the clause. Can be null.
     */
    public CreateAliasEvent(final String associationPath, final String alias, final JoinType joinType,
                            final Criterion withClause) {

        this(MethodSig.ASSOC_PATH_AND_ALIAS_AND_JOIN_TYPE, associationPath, alias, joinType, withClause);
    }
    ...
    private CreateAliasEvent(final MethodSig methodSig, final String associationPath, final String alias,
                             final /*@Nullable*/JoinType joinType, Criterion withClause) {
    ...
    public void onEvent(final Criteria crit) {
        ...
        switch (methodSig) {
            ...
            case ASSOC_PATH_AND_ALIAS_AND_JOIN_TYPE:
                ...
                break;
            case ASSOC_PATH_AND_ALIAS_AND_JOIN_TYPE_AND_WITH_CLAUSE:
                crit.createAlias(associationPath, alias, joinType, withClause);
                break;
            default:
