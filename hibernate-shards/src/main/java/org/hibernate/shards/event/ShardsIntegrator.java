 ...
 */
package org.hibernate.shards.event;
...
/**
 * Provides integration for Shards into Hibernate, which mainly means registering the proper event listeners.
 *
 * @author Steve Ebersole
 * @author Adriano Machado
 */
public class ShardsIntegrator implements Integrator {
	private static final CoreMessageLogger LOG = Logger.getMessageLogger( CoreMessageLogger.class, ShardsIntegrator.class.getName() );
