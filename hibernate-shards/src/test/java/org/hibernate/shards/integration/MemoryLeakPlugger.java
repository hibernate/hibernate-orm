...
public class MemoryLeakPlugger {
    ...
    static final LobCreationContext.Callback[] NO_CALLBACKS = new LobCreationContext.Callback[0];

    static final Object[] ONE_CALLBACK_ARRAY = {NO_CALLBACKS};

    static final Class[] SET_THREAD_CALLBACKS_ARGS = {LobCreationContext.Callback[].class};
