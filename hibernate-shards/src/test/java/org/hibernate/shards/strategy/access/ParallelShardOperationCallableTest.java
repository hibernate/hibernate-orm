...
import org.hibernate.shards.defaultmock.ShardOperationDefaultMock;
...
public class ParallelShardOperationCallableTest {
    ...
    public void testCountDown() throws Exception {
        ...
        Assert.assertEquals(latchSize - 1, latch.getCount());
        // addResult returns false so latch is only decremented by 1
        callable.call();
        Assert.assertEquals(latchSize - 2, latch.getCount());
        ...
        Assert.assertEquals(latchSize - 3, latch.getCount());
        ...
        Assert.assertEquals(latchSize - 5, latch.getCount());
    }
}
