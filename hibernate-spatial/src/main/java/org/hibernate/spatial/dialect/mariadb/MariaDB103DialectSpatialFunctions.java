...
/**
 * An {@code Iterable} over the spatial functions supported by MariaDB 10.3 and later.
 *
 * @author Nicklas Wallgren
 */
class MariaDB103DialectSpatialFunctions extends SpatialFunctionsRegistry {

	MariaDB103DialectSpatialFunctions() {
		functionMap.put(
