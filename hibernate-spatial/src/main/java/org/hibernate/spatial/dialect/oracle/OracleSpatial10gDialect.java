...
public class OracleSpatial10gDialect extends Oracle10gDialect implements SpatialDialect, Serializable {
	...
	public OracleSpatial10gDialect() {
		...
		registerFunction( "envelope", new NamedSqmFunctionTemplate( "SDO_GEOM.SDO_MBR" ) );
		registerFunction( "astext", new AsTextFunction() );
		registerFunction( "asbinary", new NamedSqmFunctionTemplate( "SDO_UTIL.TO_WKBGEOMETRY", StandardBasicTypes.BINARY ) );
		registerFunction(
				"isempty",
		...
		registerFunction( "transform", new NamedSqmFunctionTemplate( "SDO_CS.TRANSFORM" ) );
	 ...
	 */
	private static class AsTextFunction extends NamedSqmFunctionTemplate {
	 ...
	 */
	private class SpatialRelateFunction extends NamedSqmFunctionTemplate {
	...
	private class SpatialAnalysisFunction extends NamedSqmFunctionTemplate {
	...
	private class SpatialAggregationFunction extends NamedSqmFunctionTemplate {
