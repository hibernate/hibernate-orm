 ...
 * only once before and afterQuery all tests (since these should prepare static members).
 * Hibernate-specific {@link org.hibernate.testing.BeforeClassOnce} and {@link org.hibernate.testing.AfterClassOnce}
 * will be executed before and afterQuery each set of tests with given parameters.
 *
