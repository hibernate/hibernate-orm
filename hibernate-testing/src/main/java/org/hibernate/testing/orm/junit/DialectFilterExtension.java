...
public class DialectFilterExtension implements ExecutionCondition {
	...
	static class DialectVersionKey {
		private final Class<? extends Dialect> dialect;
		private final DatabaseVersion version;

		public DialectVersionKey(Class<? extends Dialect> dialect, DatabaseVersion version) {
		...
		public boolean equals(Object o) {
			...
			DialectVersionKey that = (DialectVersionKey) o;
			return dialect.equals( that.dialect )
					&& version.getDatabaseMajorVersion() == that.version.getDatabaseMajorVersion()
					&& version.getDatabaseMinorVersion() == that.version.getDatabaseMinorVersion()
					&& version.getDatabaseMicroVersion() == that.version.getDatabaseMicroVersion();
		}

		@Override
		public int hashCode() {
			int result = dialect.hashCode();
			result = 31 * result + version.getDatabaseMajorVersion();
			result = 31 * result + version.getDatabaseMinorVersion();
			result = 31 * result + version.getDatabaseMicroVersion();
			return result;
		}
	}
