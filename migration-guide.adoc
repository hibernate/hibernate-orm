...
Collection delta production is now associated with `CollectionSemantics` through
the new default `getCollectionDeltaProducer()` method.  Custom semantics remain
source compatible and use the conservative compatibility producer unless they
