...
** Removed `org.hibernate.engine.spi.Mapping` in favor of `org.hibernate.type.spi.TypeConfiguration`, `org.hibernate.boot.Metadata` or `org.hibernate.metamodel.RuntimeMetamodels`
