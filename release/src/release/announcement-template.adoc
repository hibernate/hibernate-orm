...
:migration-guide-url: {docs-url}/migration-guide/
:intro-guide-url: {docs-url}/introduction/html_single/
:user-guide-url: {docs-url}/userguide/html_single/
...
- the link:{docs-url}/incubating/incubating.txt[incubating elements report] (`@Incubating`)
- the link:{docs-url}/deprecated/deprecated.txt[deprecated elements report] (`@Deprecated`)
- the link:{docs-url}/removal/removal.txt[removal elements report] (`@Remove`)
- the link:{docs-url}/internals/internal.txt[internal elements report] (internal packages, `@Internal`)
