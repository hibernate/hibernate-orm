...
The generated sources are written to `build/generated/sources/schemaAnnotations` by default. The JDBC
driver must be available from the project's runtime classpath.
