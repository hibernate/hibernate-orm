...
public class EnhancementTask extends DefaultTask {
	...
	public EnhancementTask(EnhancementSpec enhancementDsl, SourceSet mainSourceSet, Project project) {
	...
	public void enhanceClasses(InputChanges inputChanges) {
		...
		// todo : we need to make sure the file timestamp, etc remain the same so that Gradle
		//		properly understands up-to-date-ness on the next run.
