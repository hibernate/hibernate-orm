 ...
 *
 * <p>Unlike {@code hbm2orm} which uses the old {@code MappingExporter},
 * this goal uses Hibernate's metadata model and the new models-based
 * {@code MappingXmlExporter} to produce the mapping.xml files.</p>
 */
@Mojo(
	name = "hbm2mapping-native",
	defaultPhase = GENERATE_RESOURCES,
	requiresDependencyResolution = ResolutionScope.RUNTIME)
public class TransformHbmToMappingMojo extends AbstractNativeMojo {
