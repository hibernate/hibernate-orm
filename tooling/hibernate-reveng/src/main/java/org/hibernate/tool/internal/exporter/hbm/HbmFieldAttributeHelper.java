...
class HbmFieldAttributeHelper {
	...
	String getAccessType(FieldDetails field) {
	...
	boolean isTimestamp(FieldDetails field) {
	...
	boolean isPropertyUpdatable(FieldDetails field) {
		Column col = field.getDirectAnnotationUsage(Column.class);
		return col == null || col.updatable();
	}

	boolean isPropertyInsertable(FieldDetails field) {
		Column col = field.getDirectAnnotationUsage(Column.class);
	...
	Map<String, String> getGeneratorParameters(FieldDetails field) {
	...
	String getGeneratorClass(FieldDetails field) {
	...
	String getHibernateTypeName(FieldDetails field) {
	...
	boolean hasTypeParameters(FieldDetails field) {
		Type typeAnn = field.getDirectAnnotationUsage(Type.class);
	...
	Map<String, String> getTypeParameters(FieldDetails field) {
		Type typeAnn = field.getDirectAnnotationUsage(Type.class);
		if (typeAnn != null && typeAnn.parameters() != null && typeAnn.parameters().length > 0) {
			Map<String, String> params = new LinkedHashMap<>();
	...
	String getColumnAttributes(FieldDetails field) {
		Column col = field.getDirectAnnotationUsage(Column.class);
	...
	String getColumnComment(FieldDetails field) {
