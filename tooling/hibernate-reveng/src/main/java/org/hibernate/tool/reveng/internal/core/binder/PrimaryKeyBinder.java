...
import org.hibernate.tool.reveng.internal.core.binder.ForeignKeyUtils.ForeignKeyForColumns;
import org.hibernate.tool.reveng.internal.core.util.EnhancedBasicValue;
import org.hibernate.tool.reveng.internal.core.util.EnhancedComponent;
...
class PrimaryKeyBinder extends AbstractBinder {
	...
	private EnhancedComponent handleCompositeKey(
		...
		result.setFlattened(false);
		result.setGeneratedComponentClassName(getCompositeIdName(rc));
