...
import static org.hibernate.tool.reveng.internal.export.java.MetaAttributeConstants.CLASS_DESCRIPTION;
import static org.hibernate.tool.reveng.internal.export.java.MetaAttributeConstants.SCOPE_CLASS;
import static org.hibernate.tool.reveng.internal.export.java.MetaAttributeConstants.CLASS_MODIFIER;
import static org.hibernate.tool.reveng.internal.export.java.MetaAttributeConstants.INTERFACE;
			...
			if ( subProperty.isComposite() ) {
				...
				if ( !selectable.isFormula() ) {
					...
					buildColumnAnnotation(
							selectable, annotations, subProperty.isInsertable(), subProperty.isUpdatable()
					);
					annotations.append( " ), " );
				}
			}
