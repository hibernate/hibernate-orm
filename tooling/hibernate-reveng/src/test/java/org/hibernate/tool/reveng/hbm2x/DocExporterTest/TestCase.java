...
public class TestCase {
	...
	public void testExporter() {
		...
		JUnitUtil.assertIsNonEmptyFile(new File(srcDir, "entities/org/hibernate/tool/reveng/hbm2x/Customer.html") );
		assertTrue(new File(srcDir, "entities/org/hibernate/tool/reveng/hbm2x/UPerson.html").exists() );
		JUnitUtil.assertIsNonEmptyFile(new File(srcDir, "entities/org/hibernate/tool/reveng/hbm2x/UUser.html") );
		if (!ignoreDot) {
	...
	public void testGenericsRenderedCorrectly() {
		// A unique customer comment!
		File tableFile = new File(srcDir, "entities/org/hibernate/tool/reveng/hbm2x/Customer.html");
		JUnitUtil.assertIsNonEmptyFile(tableFile);
		assertNull(
	...
	public void testInheritedProperties() {
		File entityFile = new File(srcDir, "entities/org/hibernate/tool/reveng/hbm2x/UUser.html");
