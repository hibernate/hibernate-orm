...
public class TestCase {
	...
	public void testPackageFileGeneration() {
		...
		ge.start();
		JUnitUtil.assertIsNonEmptyFile(new File(outputDir, "org/hibernate/tool/reveng/hbm2x/genericAuthor.txt"));
		JUnitUtil.assertIsNonEmptyFile(new File(outputDir, "org/hibernate/tool/reveng/hbm2x/genericArticle.txt"));
		JUnitUtil.assertIsNonEmptyFile(new File(outputDir, "org/hibernate/tool/reveng/hbm2x/genericArticle.txt"));
	...
	public void testPropertySet() throws IOException {
		...
		p.setProperty("hibernatetool.myTool.toolclass", "org.hibernate.tool.reveng.hbm2x.GenericExporterTest.TestCase$UnqualifyTool");
		...
		try (FileInputStream is = new FileInputStream(new File(outputDir, "org/hibernate/tool/reveng/hbm2x/genericArticle.txt"))) {
			generated.load(is);
		}
