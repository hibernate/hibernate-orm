...
public class TestCase {
	...
	public void testFileExistence() {
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir, "org/hibernate/tool/reveng/hbm2x/HashEquals.java"));
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir, "org/hibernate/tool/reveng/hbm2x/Address.java"));
	...
	public void testCompilable() {
		...
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled, "org/hibernate/tool/reveng/hbm2x/HashEquals.class"));
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled, "org/hibernate/tool/reveng/hbm2x/Address.class"));
	}
	...
	public void testNoVelocityLeftOvers() {
		assertNull(FileUtil
				.findFirstString(
						...
						new File(
								srcDir,
								"org/hibernate/tool/reveng/hbm2x/HashEquals.java")));
		assertNull(FileUtil
				.findFirstString(
						"$",
						new File(
								srcDir,
								"org/hibernate/tool/reveng/hbm2x/Address.java")));
	}
