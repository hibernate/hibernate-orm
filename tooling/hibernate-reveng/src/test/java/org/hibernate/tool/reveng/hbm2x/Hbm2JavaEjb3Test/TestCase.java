...
public class TestCase {
	...
	public void testFileExistence() {
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Author.java"));
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Article.java"));
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Train.java"));
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Passenger.java") );
		JUnitUtil.assertIsNonEmptyFile(new File(
				srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/TransportationPk.java") );
	}
	...
	public void testCompile() {
		...
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Article.class") );
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Author.class") );
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Passenger.class") );
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Train.class") );
		JUnitUtil.assertIsNonEmptyFile(new File(
				compiled,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/TransportationPk.class") );
	}
	...
	public void testEqualsHashCode() throws Exception {
		...
		String articleSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Article.java").toPath());
	...
	public void testAnnotationColumnDefaults() throws Exception {
		...
		String trainSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaEjb3Test/Train.java").toPath());
