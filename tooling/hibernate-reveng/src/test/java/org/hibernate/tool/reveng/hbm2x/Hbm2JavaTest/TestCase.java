...
public class TestCase {
	...
	public void testPackageName() throws Exception {
		String orderSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaTest/Order.java").toPath());
		assertTrue(orderSource.contains("package org.hibernate.tool.reveng.hbm2x.Hbm2JavaTest;"),
	...
	public void testUseRawTypeNullability() throws Exception {
		String productSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaTest/Product.java").toPath());
	...
	public void testEqualsHashCode() throws Exception {
		...
		String addressSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaTest/Address.java").toPath());
	...
	public void testDynamicComponent() {
		...
		var ctx = new org.hibernate.tool.reveng.internal.builder.hbm.HbmBuildContext();
		...
		org.hibernate.tool.reveng.internal.builder.hbm.HbmComponentBuilder
	...
	public void testUserTypes() throws Exception {
		...
		String customerSource = Files.readString(new File(srcDir,
				"org/hibernate/tool/reveng/hbm2x/Hbm2JavaTest/Customer.java").toPath());
