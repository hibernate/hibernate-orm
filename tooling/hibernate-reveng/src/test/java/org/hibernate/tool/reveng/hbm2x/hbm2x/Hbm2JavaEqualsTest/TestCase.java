 ...
 */
package org.hibernate.tool.reveng.hbm2x.Hbm2JavaEqualsTest;
...
public class TestCase {
	...
	private static final String TEST_ENTITY_HBM_XML =
			"<hibernate-mapping package='org.hibernate.tool.reveng.hbm2x.Hbm2JavaEquals'>"+
	...
	private static final String TEST_ENTITY_PROXY_JAVA =
			"package org.hibernate.tool.reveng.hbm2x.Hbm2JavaEquals;"+ System.lineSeparator() +
	...
	public void testEqualsWithoutProxy() throws Exception {
		...
		Class<?> entityClass = ucl.loadClass("org.hibernate.tool.reveng.hbm2x.Hbm2JavaEquals.UnProxiedTestEntity");
	...
	public void testEqualsWithProxy() throws Exception {
		...
		ClassLoader oldLoader = Thread.currentThread().getContextClassLoader();
		URLClassLoader ucl = new URLClassLoader(urls, oldLoader );
		Class<?> entityClass = ucl.loadClass("org.hibernate.tool.reveng.hbm2x.Hbm2JavaEquals.ProxiedTestEntity");
		Class<?> entityProxyInterface = ucl.loadClass("org.hibernate.tool.reveng.hbm2x.Hbm2JavaEquals.TestEntityProxy");
		Constructor<?> entityClassConstructor = entityClass.getConstructor();
		Method setId = entityClass.getMethod("setId", int.class);
