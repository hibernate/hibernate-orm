...
public class TestCase {
	...
	public static void beforeClass() throws Exception {
		File originFolder =
			new File(Objects.requireNonNull(TestCase.class
							.getClassLoader()
							.getResource("org/hibernate/tool/reveng/ide/completion/ModelCompletion/resources"))
				.toURI())
				.getParentFile();
		File destinationFolder = new File(
				outputFolder,
				"org/hibernate/tool/reveng/ide/completion/ModelCompletion");
	...
	public void testDottedFromPartialEntityName() {
		...
		for (HQLCompletionProposal proposal : completionProposals) {
			...
			assertEquals(caretPosition, proposal.getReplaceStart());
			assertEquals(caretPosition, proposal.getReplaceEnd());
			assertTrue(proposal.getCompletion().startsWith("ool.reveng.ide.completion"));
		}
	}
