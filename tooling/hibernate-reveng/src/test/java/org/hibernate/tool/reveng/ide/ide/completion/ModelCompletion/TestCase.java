...
package org.hibernate.tool.reveng.ide.completion.ModelCompletion;

import org.hibernate.boot.Metadata;
import org.hibernate.boot.MetadataSources;
import org.hibernate.boot.registry.StandardServiceRegistryBuilder;
import org.hibernate.cfg.AvailableSettings;
import org.hibernate.tool.reveng.ide.completion.*;
...
public class TestCase {
    ...
    public void testAliasRef() {
		...
		assertEquals(caretPosition, proposal.getReplaceStart());
		assertEquals(caretPosition, proposal.getReplaceEnd());
		assertEquals("org.hibernate.tool.reveng.ide.completion.ModelCompletion.Product", proposal.getEntityName());
