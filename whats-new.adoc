...
== New Specification APIs for projections and assignments

The `QuerySpecification` APIs have been enhanced with:

- `ProjectionSpecification` and `SimpleProjectionSpecification`,
- `UpdateSpecification` and `DeleteSpecification`, along with
- support for ``Assignment``s in ``UpdateSpecification``s.
