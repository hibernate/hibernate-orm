...
Optionally, the application may provide a `@Changelog` entity tracking information about each changeset.
The `AuditLog` object may be used to query the audit log.

For examples and more details, see link:{versionDocBase}/introduction/html_single/Hibernate_Introduction.html#temporal-data[Temporal data] and link:{versionDocBase}/introduction/html_single/Hibernate_Introduction.html#audit-logs[Audit logs] in _A Short Guide to Hibernate 7_.
