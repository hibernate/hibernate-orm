...
The annotation processor now propagates `@DenyAll`, `@PermitAll`, and `@RolesAllowed` from repository interfaces to generated implementations, allowing Jakarta EE containers to enforce role-based access control on repositories.
