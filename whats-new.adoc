...
8.0 adds a new `GetReferenceOption` which can be used with overloaded forms of `Session.getReference()`.  The main use case for this is the ability to perform `Session.getReference()` based on natural-id (`KeyType#NATURAL`) -
