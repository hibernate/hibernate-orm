...
For examples and more details, see the _Audit Logs_ section of the link:{versionDocBase}/introduction/html_single/Hibernate_Introduction.html#audit-logs[Introduction].
